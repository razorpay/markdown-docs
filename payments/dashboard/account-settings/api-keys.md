...
### 7. Who has access to the API Keys?
         ...
         Only users with the **Owner** or **Admin** role have access to the API keys. Know more about [standard user roles & permissions](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/manage-team.md#standard-user-roles).
