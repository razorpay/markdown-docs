...
---
PayU | - [Emandate (Live)](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/recurring-payments/emandate/integrate.md)
- [Cards (Live)](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/recurring-payments/cards/integrate.md)
- [UPI Autopay (Live)](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/recurring-payments/upi/create-authorization-transaction.md)

---
Razorpay | - [Emandate (Live)](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/recurring-payments/emandate/integrate.md)
- [Cards (Live)](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/recurring-payments/cards/integrate.md)
- [UPI Autopay (Live)](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/recurring-payments/upi/create-authorization-transaction.md)
...
2. You should have an [active Razorpay account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/set-up.md) with [Optimizer](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/optimizer.md) enabled.
...
### Step1: Add PayU as a Payment Provider
         ...
         Know how to [add PayU as a payment provider](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/optimizer/payu.md#add-payu-as-a-payment-provider).
