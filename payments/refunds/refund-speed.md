...
3. In the **Default Refund Speed** section, choose between **Normal Refund** and **Instant Refund**.
    ...
    **Handy Tips**
    ...
    The chosen value is also applied as the default speed in the [Refund API request](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/refunds.md).
