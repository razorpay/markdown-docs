...
> **Handy Tips**
> 
> You can [download reports](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/dashboard.md#reports) for your sub-accounts and see the real-time limit assigned to them.
> 
...
1. [Sign Up](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/set-up.md#new-users) on the RazorpayX Dashboard.
2. Open a [Current Account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/account-types/current-account.md#current-account) using RazorpayX.
...
> **Watch Out!**
> 
> Sub-account holders can only make [Payouts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts.md#how-to-make-payouts). 
> 
...
1. [Sign Up](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/set-up.md#new-users) to the RazorpayX Dashboard.
...
- [Current Account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/account-types/current-account.md)
- [Support](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/support.md)
