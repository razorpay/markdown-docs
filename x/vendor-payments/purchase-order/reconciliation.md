...
While making an [advance payment](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/advances.md), RazorpayX lists the PO that may be related to your payment. You can select the relevant PO to link it to the advance payment or you can choose **Advance is not against my PO**.
