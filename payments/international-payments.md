...
Check these steps to accept international payments from [Indian Businesses](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments.md#indian-businesses) and [International Businesses](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments.md#international-businesses).
...
Indian businesses can use **International Bank Transfer** to open **SWIFT accounts** and **Local bank accounts** to accept international payments.
    ...
    **International Bank Transfer** (MoneySaver Export Account) enables the [Local Currency Bank Transfer](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments/international-bank-transfer.md) method and [Swift Transfer](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments/international-bank-transfer.md) method to accept payments from buyers outside India without additional paperwork. The final settlement is done in the bank accounts of Indian businesses in INR. 
   ...
   [Local Payment Methods](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments/local-payment-methods.md) allows you to accept international payments from customers specific geographies in the form of online local payment method using the Razorpay Checkout form. 

   - [Giropay](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/giropay.md) for German customers.
   - [Sofort](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/sofort.md) for European customers.
   - [Trustly](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/trustly.md) for UK and European customers.
   - [POLi](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/poli.md) for Australian customers.
...
Select the payment method based on your business type:
    ...
    - [Cards issued by domestic banks or foreign banks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments/international-debit-credit-cards.md)

    - [International Bank Transfer](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments/international-bank-transfer.md)

    - [PayPal](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/wallets/paypal.md)

    - [Local Payment Methods](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments/local-payment-methods.md)
