...
A `draft` invoice can be issued to any one of the listed customers. Know more about [invoice states](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/invoices/states.md).
...
2. Click **Invoices**.
3. Search for the **Draft** invoice that you want to issue using the [search criteria](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/invoices/search.md).
...
You can issue a `draft` invoice using [this](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/invoices.md#issue-an-invoice/) API.
