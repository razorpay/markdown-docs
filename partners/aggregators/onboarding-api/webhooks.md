...
Know more about [Aggregators Webhooks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/partners.md).
...
Check the [sample payloads](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks.md) for the above-mentioned webhook events. 
...
You can check the events and sample payloads of [Sub-Merchant Onboarding Events](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/partners.md). Know more about [Webhook APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/partners/webhooks.md). 
...
- [Sub-Merchant Onboarding APIs Flow](https://raw.githubusercontent.com/razorpay/markdown-docs/master/partners/aggregators/onboarding-api/workflow.md)
- [List of Partner APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/partners/aggregators/onboarding-api.md)
