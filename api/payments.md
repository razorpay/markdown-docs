...
>  **Handy Tips**
> 
>  You can use Payments API only to retrieve payment details or change the status from `authorized` to `captured` and **not** to collect payments. You can use our [products](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments.md) to accept payments. 
>  

 

 Fork the Razorpay Postman Public Workspace and try the Payments APIs using your [Test API Keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/api-keys.md#generate-api-keys).
...
[About Payments](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments.md)
[Set Up Webhooks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/setup-edit-payments.md)
[Sample Payloads](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/payments.md)
