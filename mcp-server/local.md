...
Restart your AI assistant application after configuration. You should see [Razorpay MCP tools](https://raw.githubusercontent.com/razorpay/markdown-docs/master/mcp-server/tools-reference.md) become available. Test the connection by asking: **Show me available Razorpay tools**.
...
2. **Configure Advanced Options**: See [Configuration Guide](https://raw.githubusercontent.com/razorpay/markdown-docs/master/mcp-server/configuration.md) for detailed settings.
3. **Review Use Cases**: Check [practical examples](https://raw.githubusercontent.com/razorpay/markdown-docs/master/mcp-server/use-cases.md) that leverage local-only tools.
