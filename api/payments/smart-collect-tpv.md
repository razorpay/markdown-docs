...
Fork the Razorpay Postman Public Workspace and try the Smart Collect with TPV APIs using your [Test API Keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#generate-api-keys).
