...
3. Understand the [payment process](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/how-it-works.md).
...
: `string` The unique identifier of the order created in [step 1](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/cards/authentication/native-otp.md#creating-the-workflow-for-native-otp).
...
**Know More**: Know more about [API error codes](https://raw.githubusercontent.com/razorpay/markdown-docs/master/errors.md#error-response).
...
Know more about [Error Codes](https://raw.githubusercontent.com/razorpay/markdown-docs/master/errors/payments/payment-methods-error-parameters.md#cards).
