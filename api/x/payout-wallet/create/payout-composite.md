...
Use this endpoint to create a payout to a Fund Account of type wallet. Know more about [RazorpayX Composite API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/payout-composite.md). 
