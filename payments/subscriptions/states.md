...
### Paused
   ...
   - From the [Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/pause-resume-cancel.md#pause-a-subscription-via-the-dashboard).
   - Using [API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/subscriptions.md#pause-a-subscription).
