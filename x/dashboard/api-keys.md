...
After you [set up your RazorpayX account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/set-up.md), you can generate API keys in both Test mode and Live mode. 
...
- [Allowlist IPs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/dashboard/allowlist-ip.md)

### Related Information

- [About RazorpayX](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x.md)
- [Payout APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/apis.md)
