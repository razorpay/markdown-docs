...
The parameter descriptions and errors are present in the [Create Transfers from Orders](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/route.md) documentation.

## Set Up Webhooks

To receive notifications on when a transfer is processed, set up the [`transfer.processed` webhook event](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/setup-edit-payments.md). Check the [sample payload for Transfer Processed](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/route.md#transfer-processed).
...
- [Set up Platform and Third-Party Accounts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/partners/technology-partners/control-of-funds/set-up-accounts.md)
- [Refunds and Reversals](https://raw.githubusercontent.com/razorpay/markdown-docs/master/partners/technology-partners/control-of-funds/refunds-and-reversals.md)
