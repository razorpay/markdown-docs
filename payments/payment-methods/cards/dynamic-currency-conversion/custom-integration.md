...
> **Watch Out!**
> 
> Dynamic Currency Conversion (DCC) is not available for [Razorpay Optimizer](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/optimizer.md).
> 
...
> **Handy Tips**
> 
> DCC Custom Checkout payment flow is similar to the [S2S payment flow](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/cards/dynamic-currency-conversion/s2s-integration.md).
> 

### Related Information

- [DCC S2S Payment Flow](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/cards/dynamic-currency-conversion/s2s-integration.md)
