...
> - If other [standard user roles](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/manage-team.md#standard-user-roles) need to get notifications, they can be added to the Slack channel(s).
> 
