...
`notes` _optional_
: `json object` Object consisting of key value pairs as [notes](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/understand.md#notes).
...
You can subscribe to the payment-related (`payment.authorized`, `payment.captured`) and order-related (`order.paid`) Webhooks to get notified once the customer completes the UPI payment. Know more about subscribing to [Webhooks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks.md).
