...
1. Create a [Contact](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/contacts.md#contacts).
2. Create a [Fund account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/contacts.md#fund-accounts) for the Contact.
3. Create a payout.
...
You can create Scheduled payouts created using [Bulk Upload](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/contacts/bulk-uploads.md). Select the following options while uploading the bulk upload file:
...
After a bulk file is uploaded, it is picked up for processing immediately. Know more about [bulk payouts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/bulk-payouts.md).
...
Know  more about the [states and the life cycle of a payout](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/states-life-cycle.md).
