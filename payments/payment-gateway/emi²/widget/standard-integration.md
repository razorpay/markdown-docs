...
> - This feature is only supported on [Native Website](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/native-web.md) integration.
> 
...
### 1.2 Pass Function in Affordability Widget Configuration
     ...
     : `string` The currency in which the customer should make the payment. Check the list of [supported currencies](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments.md#supported-currencies).
