...
### Sample Code
        ...
        : `string` Currency in which you want to accept the payment. For example, `GBP`. Check the [supported international currencies.](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments.md#supported-products-and-currencies)
...
### Payment Entity
         ...
         The [Payment entity](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments.md#payment-entity) will contain additional fields when the currency is not INR to provide visibility into the conversion rate.
