...
> [migrate to the 3DS2 flow](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/s2s-integration/redirect/build-integration/cards/migrate-3ds2.0.md).
> 
...
**Know more:** Razorpay supports [3DS2 transactions](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/s2s-integration/payment-methods/cards/3ds2.0.md).
...
`notes` _optional_
: `object` Key-value object used for passing tracking info. Refer to [notes](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/understand.md#notes) for more details.
...
Descriptions for the response parameters are present in the [Payments Entity](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments.md#payments-entity) parameters table.
...
Know more about [errors](https://raw.githubusercontent.com/razorpay/markdown-docs/master/errors.md).
...
[Step 2: Test Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/s2s-integration/redirect/test-integration.md)
