...
Use this endpoint to update a product's configuration and request payment methods like UPI, netbanking and card. Know about the [various error responses](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/partners/errors.md) for this API. 
