...
### 1.4 Initialise Razorpay Android Standard SDK
     ...
     Use the `setKeyId()` method of the Checkout class to dynamically add your API key id. You can generate your API keys from the [Razorpay Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/api-keys.md#generate-api-keys).
...
### 1.8 Initiate Payment and Display Checkout Form
     ...
     Create an instance of the `Checkout` and pass the payment details and options as a `JSONObject`. Ensure that you add the `order_id` generated in [Step 5](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/android-integration.md#15-create-an-order).
...
[Android Standard Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/android-integration/standard.md)
