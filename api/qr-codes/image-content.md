...
Create Razorpay [QR Codes](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/qr-codes.md) and share them with customers to accept digital payments.
...
Fork the Razorpay Postman Public Workspace and try the QR Codes (Image Content) APIs using your [Test API Keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#generate-api-keys).
