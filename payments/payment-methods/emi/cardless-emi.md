...
Following is the list of supported Payment Partners for Cardless EMI and the minimum order amount stipulated by them:
        ...
        ---
        [axio](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/emi/cardless-emi/axio.md) | `walnut369` | ₹900 
        ---
...
>         **Handy Tips**
> 
>         Check the standard [interest rates charged by Banks/Partners](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/emi/faqs.md#1-what-are-the-standard-interest-rates-charged).
>         
...
>         **Handy Tips**
> 
>         Check the standard [interest rates charged by Pay Later Providers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/emi/faqs.md#2-what-are-the-standard-interest-rates-charged).
>        
        ...
        Payment Partners | Provider Code | Minimum Order Amount 
        ---
        [ShopSe](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/emi/cardless-emi/shopse.md) | `shopse` | ₹3000
        ---
        [Snapmint](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/emi/cardless-emi/snapmint.md) | `snapmint` | None
...
See: [Cardless EMI FAQs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/emi/faqs.md#cardless-emi).
