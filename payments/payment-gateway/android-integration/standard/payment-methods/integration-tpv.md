...
### Prerequisites
         ...
         2. Integrate with the [Razorpay Android Standard Checkout SDK](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/android-integration/standard/integration-steps.md).
...
>             - Use the [Razorpay live keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#live-mode-api-keys) for prod testing.
...
- `SERVER_ERROR`: Failure at PSP.
         ...
         [Refer to the list of possible error reasons](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/android-integration/standard/payment-methods/turbo-upi/error-codes.md).
