...
Know more about [supported banks for EMI](https://raw.githubusercontent.com/razorpay/markdown-docs/master/pos/payment-methods/emi/emi-by-razorpay.md).
...
There are certain error codes specific to each payment method supported by Razorpay. Know more about the [Payment Method Error Codes](https://raw.githubusercontent.com/razorpay/markdown-docs/master/errors/payments/payment-methods-error-parameters.md).
