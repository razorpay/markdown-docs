...
You have successfully integrated Payroll with Jibble. Set up your organisation's [leave and attendance](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/leaves.md) policy on Jibble. Know how Payroll [retrieves the Loss of Pay data](#verify-lop-in-payroll) to calculate the monthly payroll.
...
Once your employees mark their attendance on Jibble, you can sync the loss of pay details from Jibble before you [execute payroll](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/run-payroll.md). To verify the loss of pay data:
...
You can edit the loss of pay days and deductions until you execute payroll. Know more about the [execute payroll checklist](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/execute-payroll.md).

### Related Information 

- [About Integrations](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/integrations.md) 
- [Leaves and Attendance](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/leaves.md)
- [Whatsapp Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/integrations/whatsapp.md)
