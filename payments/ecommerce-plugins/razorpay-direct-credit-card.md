...
>              - If you are a new Razorpay user, click **I am new to Razorpay** and [set up](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/set-up.md) an account.
>              
...
>          **Handy Tips**
> 
>          - Webhooks is auto-configured. You need to verify if webhooks are enabled on your [Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/ecommerce-plugins/razorpay-direct-credit-card/troubleshooting-faqs.md#7-how-can-i-verify-if-webhooks-are).
...
- [Troubleshooting and FAQs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/ecommerce-plugins/razorpay-direct-credit-card/troubleshooting-faqs.md)
- [Ecommerce Plugins](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/ecommerce-plugins.md)
