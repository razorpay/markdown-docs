...
- Ensure the [Third-Party Validation](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/third-party-validation.md) feature is activated on your account.

## Sample Code

After creating an order using the [Orders API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/orders/create.md), use the following API call to generate a UPI intent deep link and convert the returned link into a QR code:
...
: `string` Order ID generated via [Orders API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/orders/create.md).
...
5. [Poll Payment APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/fetch-with-id.md) to check the payment status.
