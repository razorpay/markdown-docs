...
- You can refund customer payments made using GoPay by following the usual [refunds](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/refunds.md) process.  
 
- GoPay payments take T+22 days to get settled to your Razorpay account.

### Supported Integrations

Secure [S2S integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/gopay/s2s-integration.md) for seamless payment processing.
