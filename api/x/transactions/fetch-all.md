...
`mode`
: `string` The payout mode. Refer to the [Supported Banks and Payout Modes section](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/payouts-cards.md#supported-banks-and-payout-modes) for more details. 
 This value is returned only when the source entity is `payout`.
