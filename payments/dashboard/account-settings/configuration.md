...
- [Configure Payment Capture Settings](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payments/capture-settings.md)
...
- [Manage Local Saved Tokens](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/cards/features/saved-cards.md).
...
### To manage fee bearer model:
       ...
       Know more about the [Convenience Fee Model](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/configuration/convenience-fees.md).
      

## Enable International Payments

By default, you can accept payments in various [international currencies supported by Razorpay](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments.md#supported-currencies).
...
> **Handy Tips**
> 
> Settlement emails will be sent to the email addresses provided on the Dashboard. Know more about [Settlements](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/settlements.md).
> 
...
> **Handy Tips**
> 
> This feature is available only to the owner user role. Know about the various [user roles](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/manage-team.md).
> 
