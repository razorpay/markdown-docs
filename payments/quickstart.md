...
[Choose Razorpay products](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments.md) based on your business requirements.

    
### Online Payments vs. Offline Payments

         Choose between digital payment processing for ecommerce and websites using [Payment Gateway](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway.md), [Magic Checkout](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout.md) and [Payment Links](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-links.md) or physical payment solutions for retail stores and face-to-face transactions with [Razorpay POS](https://raw.githubusercontent.com/razorpay/markdown-docs/master/pos.md). Know more about [online and offline payment options](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments.md#accept-payments).
        

    
### One-time Payments vs. Recurring Payments

         Select single transaction processing for individual purchases using [Payment Gateway](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway.md), [Payment Links](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-links.md) and [Payment Pages](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-pages.md) or automated recurring billing for subscriptions and regular services with [Subscriptions](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions.md). Know more about [one-time and recurring payment solutions](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments.md#accept-payments).
        

    
### No-code Products vs. Products with Coding Requirements

         Pick ready-to-use payment solutions with simple setup like [Payment Links](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-links.md), [Payment Pages](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-pages.md), [Invoices](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/invoices.md) or refer to our [Payment Gateway SDKs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway.md#integrate-payment-gateway-web-mobile-ecommerce-plugins) for advanced integration needs. Explore [no-code and developer-friendly options](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments.md#accept-payments).
        

    
### Solutions by Industry

         Find tailored payment solutions designed for your industry: [Payment Gateway](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway.md) for ecommerce, [Subscriptions](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions.md) for SaaS, [Route](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route.md) for marketplaces or [Razorpay POS](https://raw.githubusercontent.com/razorpay/markdown-docs/master/pos.md) for traditional retail businesses. View [industry-specific payment solutions](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments.md#solutions-by-industry).
        

    
### Solutions by Platform

         Integrate payments seamlessly with popular ecommerce platforms like Shopify, WooCommerce, Magento using [Payment Gateway ecommerce plugins](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway.md#integrate-payment-gateway-web-mobile-ecommerce-plugins) or build custom solutions using our [Checkout SDKs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway.md#integrate-payment-gateway-web-mobile-ecommerce-plugins) for Go, PHP, Python, Node.js and [mobile platforms](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway.md#integrate-payment-gateway-web-mobile-ecommerce-plugins) (Android, iOS, React Native, Flutter, Cordova, Capacitor). Browse [platform-specific integration guides](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments.md#solutions-by-platform).
...
### Generate API Keys
            ...
            **Important:**
            ...
            [API Keys Documentation →](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/api-keys.md)
...
### Add Team Members
            ...
            [Team Management Guide →](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/manage-team.md)
...
### Configure Webhooks
            ...
            [Webhooks Documentation →](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks.md)
...
The minimum value is 12 minutes.- The maximum value (default) is 3 days.
            ...
            [Payment Capture Guide →](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payments/capture-settings.md)
...
1. **Complete KYC**: [Submit KYC documents](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/set-up.md#2-submit-kyc-details) for live mode activation.
