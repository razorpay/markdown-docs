...
> **Handy Tips**
> 
> - For Native users, you can [integrate the widget with checkout](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/features.md#checkout-from-widget).
...
### Advantages
      ...
      - **Improve conversion rates** 
        ...
        The availability of affordable payment options such as [EMI](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/emi.md) and [Pay Later](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/pay-later.md) help boost conversion rates.
 ...
 1. Set up your [Razorpay account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/set-up.md).
...
>     **Watch Out!**
> 
>     [Eligibility Check on Widget](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/features.md#eligibility-check) is an on-demand feature. Write to us at [affordability-widget@razorpay.com](mailto:affordability-widget@razorpay.com) to get this feature enabled.
>     
...
>     **Watch Out!**
>     
>     - [Checkout from the Widget](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/features.md#checkout-from-widget) is an on-demand feature. Write to us at [affordability-widget@razorpay.com](mailto:affordability-widget@razorpay.com) to get this feature enabled.
...
>  
 ...
 You can choose to: 
 - [Integrate Affordability Widget on Web](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/native-web.md)
 - [Integrate Affordability Widget on Woocommerce website](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/woocommerce.md)
 - [Integrate Affordability Widget on your Shopify store](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/shopify.md) 
 - [Integrate Affordability Widget on Android App](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/android.md)

 ### Related Information
 
 - [Features](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/features.md)
 - [FAQs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/faqs.md)
 - [Customise the Widget on Web](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/native-web/customise.md)
 - [Customise the Widget on WooCommerce](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/woocommerce/customise.md)
 - [Customise the Widget on Shopify](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/shopify/customise.md)
 - [Create Offers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/create.md)
 - [Create No Cost EMI Offers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/no-cost-emi/create.md)
 - [Create Low Cost EMI Offers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/low-cost-emi/create.md)
 - [Payment Methods](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi².md#payment-methods)
