...
> **Handy Tips**
> 
> If you want to offer all payment methods and support refunds from the Dashboard, please use the [S2S integration mode](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/optimizer/paytm-s2s.md).
> 
...
You might be generating a unique Order id or Receipt for every order which can be passed to Paytm via [Orders API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/orders.md#orders-api). 
