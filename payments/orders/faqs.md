...
### 3. Can I view order details on the Dashboard?
        ...
        Yes, you can [view the order details](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/orders/dashboard.md#view-order-details-from-dashboard) from the Dashboard.
        

    
### 4. What are the different states of an order? 

        An order can be in one of three states: Created, Attempted, or Paid. Know more about the [different states of an order](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/orders.md#order-states).
