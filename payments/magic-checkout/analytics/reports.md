...
### Order Reports
         ...
         ---
         `order_status` | Status of the order. Know more about [Order Status](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/orders.md#order-states).
         ---
         `payment_method` | Code of the payment method used. Know more about [Razorpay Payment Methods](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods.md).
         ---
         `payment_amount` | Amount paid through the payment method in smallest currency unit.
         ---
         `payment_status` | Status of payment. Know more about [Payment Status](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payments.md#payment-life-cycle).
         ---
