...
Know more about calculating [salary based on Loss of Pay](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/run-payroll.md#calculations). 

## Leave Encashment 

When an employee leaves your organisation, you can pay them for the leaves they have not availed from their balance. Know more about [Leave Encashment during exit](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/run-payroll.md#full-and-final-settlement).
