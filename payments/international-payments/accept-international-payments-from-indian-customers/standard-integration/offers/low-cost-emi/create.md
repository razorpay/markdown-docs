...
5. **Show Offer on Checkout**: Select this check box for the created offer to be displayed for all Standard Checkout payments including [Payment Links](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-links.md).
6. Click **Next**.
...
4. Select **EMI**.
5. Select the payment option you created for the offer on from the Dashboard. Select the EMI plan and enter the required [test details](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payments/test-card-details.md).
6. Click **Pay via EMI**
...
Know more about [integrating Low Cost EMI Offers with Standard Checkout](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/standard-integration.md).
