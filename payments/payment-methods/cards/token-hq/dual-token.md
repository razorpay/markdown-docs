...
`customer_id`
: `string` This is the Razorpay customer id. You can create a token for a specific customer using their customer id. Use the [Customers API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/customers.md) to create a customer id. This is an optional parameter.
...
Descriptions for the response parameters are present in the [Token Entity parameters table](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/cards/token-hq/dual-token.md#token-entity).
