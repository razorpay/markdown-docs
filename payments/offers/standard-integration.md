...
After creating [offers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/create.md) from the Dashboard, you have to integrate them on Razorpay Standard Checkout so that your customers can avail them while making payments.
...
---
**Amount Match** | Order amount should be more than or equal to the [Minimum Order Amount](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/create.md#instant) set in an offer.
---
...
You can [create offers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/create.md#create-offers) from the [Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/create.md).
...
- [Disable Offers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/create.md#disabling-offers)
- [Offers FAQs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/faqs.md)
