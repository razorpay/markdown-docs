...
You should enable cookies on your app to access features such as **saved cards**. Know more about [saved cards](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/checkout-features.md#flash-checkout). 
