...
[Create an offer](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/create.md) from the Dashboard.
            ...
            : `object` Criteria that qualify transactions for the offer.
                ...
                : `object` Filters on payment methods and instruments. For example, `issuer`, `apps` or `vpa`.
                    ...
                    : `object` Details of wallet payment method. 
                        ...
                        `providers`
                        : `string` List of supported wallet providers. For example, [Wallet providers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/wallets.md#supported-wallets).
