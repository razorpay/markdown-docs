...
### What is the difference between Advance Salary and Employee Loans?
         ...
         In an [Advance Salary](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/advance-salary.md), the organisation pays a portion of the employee's salary as an advance. The advance paid is recovered in installments from the employee and is usually interest-free.
...
1. Click **DISBURSE LOAN ()**. This creates the loan payout to your employees. 
    ...
    [Add funds to your Payroll account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/payroll-payouts.md#transfer-funds) in case the **DISBURSE LOAN ()** option is not available.
...
> **Handy Tips**
> 
> In the [employees' profile](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/employees.md#set-up-profile) view, you can either set a limit on the total perquisite amount allowed (only in [custom salary structure](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/salary.md#setup-salary-structure)) or let Payroll calculate the amount allowed automatically. This is beneficial in cases of employee's [salary revision](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/run-payroll.md#revise-salary). 
> 
...
- Employees can view their loan infomation from their [profile](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/employees.md#set-up-profile). 

### Related Information

- [About Salary](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/salary.md)
