...
- You must have a [RazorpayX - Current Account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/account-types/current-account.md).
...
- There should be no balance in your Payroll account before integration. 
    - If there is any balance, add the Current Account as a [Contractor](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/administrator.md#differences-between-employee-and-contractor) and [transfer funds](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/payroll-payouts.md#transfer-funds) to this account. 
...
- If you have [approval workflows (maker-checker)](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/manage-teams/approval-workflow.md) enabled on your RazorpayX account, the same is applicable to all transactions originating from Payroll by default.
...
- [RazorpayX - Current Account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/account-types/current-account.md)
