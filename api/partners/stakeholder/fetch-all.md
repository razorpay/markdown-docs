...
Use this endpoint to retrieve the details of all stakeholders for a given account. Know about the [various error responses](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/partners/errors.md) for this API.
