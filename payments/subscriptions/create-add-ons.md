...
- [Using APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/subscriptions.md#create-an-add-on).
...
You can create add-ons for the Subscriptions using [Create an Add-on](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/subscriptions.md#create-an-add-on) API.
