...
### Prerequisites
         ...
         2. Integrate with [Razorpay Android Custom SDK](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/android-integration/custom/build-integration.md).
...
`customer_id`
: The unique identifier of the customer. You can create `customer_id` using the [Customers API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/customers.md).
...
: Order ID generated via [Orders API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/third-party-validation.md#upi-only).
