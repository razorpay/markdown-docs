...
You can seamlessly integrate Turbo UPI with Razorpay iOS Standard SDK. Explore the full potential of [Razorpay Turbo UPI](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/upi/turbo-upi.md) and know How it Works.

## Prerequisites

- Integrate with [Razorpay iOS Standard SDK](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/ios-integration/standard/integration-steps.md). Ensure that you integrate with SDK version 1.0.0 or higher.
...
Ensure your customers [onboard with Razorpay Turbo UPI](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/upi/turbo-upi.md#2-onboarding-flow) to get started.
...
- `internal`
         ...
         [Refer to the list of possible error reasons](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/ios-integration/standard/payment-methods/turbo-upi/error-codes.md).
