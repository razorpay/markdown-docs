...
`customer_id`
: The unique customer ID. To create a customer, refer the [Customer API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/customers.md) section.
