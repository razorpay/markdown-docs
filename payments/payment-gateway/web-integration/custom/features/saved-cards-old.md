...
- [Generate the API Keys on Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings.md#api-keys).

Watch the video to see how to generate API key in Test Mode.

- [Integrate with our Custom Checkout](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/custom.md).
...
**Read more:** [Learn more about Flash Checkout.](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings.md#flash-checkout)
...
**Read More**: [Learn more about Customers API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/customers.md).
...
**Read more:** [Learn about the other Checkout parameters](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/custom/build-integration.md) for web integration.
