...
After you [set up and configure](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/tally/set-up.md) the integration, you can send your Purchase Vouchers to RazorpayX and sync them for reconciliation.
...
> 
> If the section is empty, [create a Contact](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/contacts.md) of the type Vendor and [create a Fund Account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/fund-accounts.md) for that Contact. 
> 
...
You have now successfully synced a Purchase Voucher made in Tally to RazorpayX. Know more about [syncing Payment Vouchers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/tally/sync-payment-vouchers.md). 

## Pay Invoices

After you send and sync the vouchers in RazorpayX, you can pay the invoices in the following ways:
- [Pay your vendor immediately](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments.md).
- [Pay vendor partially](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/vendor-payouts/partial-payouts.md).
- [Schedule the vendor payment](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/vendor-payouts/scheduled-payouts.md).
- [Make vendor payouts in bulk](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/vendor-payouts/bulk.md).

All the payments made can be brought back to Tally. Know more about [bringing bills](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/tally/bring-bills.md) to Tally from RazorpayX.

### Related Information

- [Bring Bills to Tally](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/tally/bring-bills.md) 
