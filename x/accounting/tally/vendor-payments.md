...
You can automate this process to an extent by setting [**Contact Rules**](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/accounting/zohobooks.md#rules). This means that you can select a corresponding **Tally Expense Account** to which you want the vendor payments made to that particular vendor, to sync. 
