...
You can make payouts to Amazon Pay Gift Cards using your [RazorpayX Lite](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/account-types/razorpayx-lite.md). Once you process the payout, the amount gets instantly credited to your end customer's Amazon Pay Gift Card balance. 
...
> **Handy Tips**
> 
> - This feature is available only on [RazorpayX Lite](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/account-types/razorpayx-lite.md).
...
1. Create a [Contact](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/contacts.md#create-a-contact-with-fund-account).
...
See: [Payout states and life cycle](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/states-life-cycle.md).
...
Know more about [creating a Fund account via API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/payout-wallet/create/fund-account.md) with `type: wallet` and `provider: amazonpay` and [creating payouts via Amazon Pay](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/payout-wallet/create/payout.md).
...
Know more about to the [Amazon Branding Guidelines](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payout-wallet/amazon/branding-guidelines.md).
...
- [Amazon Brand Guidelines](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payout-wallet/amazon/branding-guidelines.md)
- [Amazon Payout APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/payout-wallet.md)
