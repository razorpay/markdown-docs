...
- Integrate with Razorpay Magic Checkout:
    - [Native (Web)](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/web.md)
    - [Android](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/android-integration.md)
    - [iOS](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/ios-integration.md)
    - [React Native: Android](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/react-native-android-integration.md)
    - [React Native: iOS](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/react-native-ios-integration.md)
    - [Flutter](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/flutter-integration.md)
    - [Capacitor](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/capacitor-integration.md)
...
[Payment Configuration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/payment-configuration.md#configure-payment-options)
