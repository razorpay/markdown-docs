...
Know more about [Tokens](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/recurring-payments/cards/integrate.md#fetch-card-mandate-registration-details).
...
> **Handy Tips**
> 
> You can also retrieve the `token_id` from the [payment.authorized webhook](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/recurring-payments/webhooks.md#payment-authorized).
> 
