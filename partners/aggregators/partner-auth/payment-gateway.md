...
Integrate with [Orders API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/orders.md) to create an order. Given below is the sample code for Create an Order API. Pass the `account_id` of the sub-merchant using `X-Razorpay-Account` in the header.
...
Check [our SDKs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/server-integration.md) for the supported platforms.
...
You can view the payments received from customers on the sub-merchant's  Dashboard. Also, you can retrieve the status of the payments by polling our [APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api.md).
...
- [Razorpay Payment Gateway: Web Standard Integration Guide](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/standard.md).
