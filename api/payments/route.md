...
You should create a linked account to integrate Route and start transferring payments to vendors.
 ...
 Below are the steps to integrate Route. You can also refer to our comprehensive [Route Integration guide](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/integration-guide.md).

 1. [Create a Linked Account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/route/create-linked-account.md)
 2. [Create a Stakeholder](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/route/create-stakeholder.md)
 3. [Request a Product Configuration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/route/request-product-config.md)
 4. [Update a Product Configuration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/route/update-product-config.md)
 5. Transfer funds to Linked Accounts using [Orders](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/route/create-transfers-orders.md), [Payments](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/route/create-transfers-payments.md) or [Direct Transfer](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/route/direct-transfers.md) methods.

 Fork the Razorpay Postman Public Workspace and try the Linked Account APIs using your [Test API Keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#generate-api-keys).
...
[About Linked Accounts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/linked-account.md)
[About Route](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route.md)
[Integrate With Route](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/integration-guide.md)
