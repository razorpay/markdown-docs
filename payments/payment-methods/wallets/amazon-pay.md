...
> 
    ...
    To list external wallets on your web application, you need to first integrate our [Checkout form](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/standard.md). After you integrate, follow the steps given below:
