...
> - You can perform the eligibility check on methods and instruments enabled for your account. Know how to [check the payment methods enabled](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods.md#view-payment-methods) for your account.
> 
...
: `object` Customer details.
  ...
  `id` 
  : `string` Unique identifier of the customer created using [Customers API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/customers.md). For example, `cust_1Aa00000000004`.
...
> 
> Refer to the [Configurations](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/eligibility-check/configurations.md) doc for eligibility checks on specific methods or instruments.
> 
...
> **Handy Tips** 
> 
> [Standard Errors](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/understand.md) for Razorpay APIs are applicable.
> 
...
- [Debit Card EMI Providers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/faqs.md#5-can-you-provide-a-list-of-the)
- [Cardless EMI Providers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/faqs.md#1-what-are-the-standard-interest-rates-charged)
- [Pay Later Providers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/faqs.md#2-what-are-the-standard-interest-rates-charged)
