...
Ensure you have read the [product document](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/smart-collect/va-vpa-qr.md) before you proceed with the API integration.
...
- [Create a customer](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/customers.md) (optional)
- [Create a Customer Identifier](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/smart-collect/va-vpa-qr/api/create.md)
- Share Customer Identifier details with customer
- [Setup webhooks to receive payment notifications](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/smart-collect/va-vpa-qr/notification.md) (optional)
...
`customer_id`
: `string` Unique identifier of the customer the virtual account is linked with. Refer the [Customer API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/customers.md) section to learn more.
