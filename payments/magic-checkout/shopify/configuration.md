...
### Manually Review COD Orders
         ...
         Once you enable manual review, you can review the COD orders and take necessary actions. Refer to the [COD Orders](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/order-settings/review-cod-orders.md#cod-orders) section for the next steps.
...
Know how to [create offers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/create.md).
