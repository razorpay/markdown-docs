...
- [Generate the API keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#generate-api-keys).
- Integrate with [Razorpay Custom Checkout](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/custom.md).
...
: `string` The unique identifier of the customer. Learn how to create a customer using the [Customers API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/customers.md). This parameter is mandatory if you want to associate the virtual account with a specific customer.
...
`notes`
: `json object` Any custom notes you might want to add to the virtual account can be entered here. Refer [Notes section of the API Reference Guide](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/understand.md#notes) to learn more.

`customer_id`
: `string` Unique identifier of the customer to whom the virtual account is linked. Refer the [Customer API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/customers.md) section to learn more.
...
You must subscribe to the `virtual_account.credited` webhook event on the Dashboard to receive notifications whenever customers make payments using bank transfers. Learn how to [setup webhooks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks.md#set-up-webhooks).
