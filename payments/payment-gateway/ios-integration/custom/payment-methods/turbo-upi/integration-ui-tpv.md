...
> **Watch Out!**
> 
> To whitelist the customer account, use our S2S [Customer Add Bank Account API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/customers/bank-accounts.md#1-add-bank-account-of-customer). This optional functionality ensures that only pre-approved accounts are displayed to users during the onboarding process, streamlining the experience and enhancing security.
> 
...
### Prerequisites
         ...
         3. Integrate with the [Razorpay iOS Custom SDK](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/ios-integration/custom/build-integration.md).
...
>          - Use the `rzp_test_8UzRYt0d70Ntgz` API key id for testing on the UAT environment and the [Razorpay live keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#live-mode-api-keys) for prod testing.
>          
...
- `internal`
         ...
         [Refer to the list of possible error reasons](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/ios-integration/custom/payment-methods/turbo-upi/error-codes.md).
