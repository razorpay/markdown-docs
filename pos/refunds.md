...
You can use [Normal Refunds](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/refunds/normal.md) to refund payments to your customers. The amount is refunded within 5-7 working days.

## Dashboard Actions

You can perform the following actions on refunds from the Dashboard:

- [View Refunds](https://raw.githubusercontent.com/razorpay/markdown-docs/master/pos/refunds/view.md)
- [Issue Refunds](https://raw.githubusercontent.com/razorpay/markdown-docs/master/pos/refunds/issue.md)
- [View Settlement Details of a Refund](https://raw.githubusercontent.com/razorpay/markdown-docs/master/pos/refunds/view.md#view-settlement-details-of-a-refund)
...
Detailed insights can be gained using reports and real-time data on the Dashboard. These reports can then be used for accounting and recon purposes. Know more about [reports](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/reports.md).
...
- [Handle refund errors](https://raw.githubusercontent.com/razorpay/markdown-docs/master/pos/refunds/errors.md)
- [Refunds API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/pos/refunds/apis.md)
- [Refunds FAQs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/pos/refunds/faqs.md)
