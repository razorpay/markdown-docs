...
: `json object` A key-value pair that can hold additional information about the payment. 
 Refer the [Notes](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/understand.md#notes) section of the API Reference Guide.
...
> **Handy Tips**
> 
> For the package name, you can check the [list of supported UPI apps](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/upi/supported-apps.md).
> 
...
- Poll Razorpay servers periodically for the payments made for the order using our [Fetch Payment APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/orders/fetch-payments.md).

- [Subscribe to the Webhook events](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/setup-edit-payments.md) created in our system for each of the following entities:
...
[Error reasons](https://raw.githubusercontent.com/razorpay/markdown-docs/master/errors.md#list-of-error-reasons-for-payments)
