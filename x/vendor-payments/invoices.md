...
4. Select an existing vendor or [create a new vendor](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/contacts.md#create-a-contact). The vendor is the person or entity to which you are making an payment to, basing an invoice received.
5. Select a Fund account for the vendor or [create a new Fund account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/fund-accounts.md#create-a-contact-with-fund-account). These are the account details (bank account or UPI ID) to which the amount is transferred.
...
Once you make the payment, it follows the [Approval Workflow](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/manage-teams/approval-workflow.md) set on your RazorpayX account.
...
- Invoices marked as `paid` are considered for TDS payments. You can calculate and pay the TDS using [Tax Payments](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/tax-payments.md).
