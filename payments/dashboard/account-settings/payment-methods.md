...
- You can also accept [international payments](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments.md#get-started).
...
>              
         ...
         4. Fill in the business website/app details and click **Proceed to update website/app**. Know more about [how to add website details](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/business-website-details.md).
         5. Fill in the GSTIN details and click **Submit**. Know more about [how to add GSTIN details](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/gst-details.md).
