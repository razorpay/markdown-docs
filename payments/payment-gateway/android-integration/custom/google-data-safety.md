...
---
App activity | Installed apps | **Yes**, only detection of installed UPI apps is done to enable [UPI intent](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/upi/upi-intent.md) functionality.
---
