...
Use this endpoint to retrieve the terms and conditions of a sub-merchant. Know about the [various error responses](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/partners/errors.md) for this API.
