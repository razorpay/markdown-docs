...
3. Copy the auth `code` from the URL and use it to obtain the new [access token](https://raw.githubusercontent.com/razorpay/markdown-docs/master/partners/technology-partners/onboard-businesses/integrate-oauth/integration-steps.md#22-get-access-token).
