...
### 5. The order status remains "Pending Payment", even after a successful Razorpay payment. Why is WooCommerce not updating my subscription payments?
     ...
     - [Subscriptions plugin for WooCommerce](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/plugins/woocommerce.md)
     - [Subscriptions plugin for WooCommerce Build Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/plugins/woocommerce/build-integration.md)
...
### 1. Can I update the plan amount or duration of Subscription when it is live?
     ...
     Yes. You can update details such as the plan amount, duration and quantity of a Subscription, even if it is live. Refer to the [Update Subscription section](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/update.md) for more details.
...
### 2. When can I update a Subscription?
     ...
     You can only update a Subscription when it is in `authenticated` and `active` states. There is no state change when you update a Subscription. Know about [Updating a Subscription](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/update.md).
...
### 2. Can all Subscriptions be paused?
     ...
     Subscriptions in the `active` state can be paused. You cannot pause a Subscription in any other state. Refer to the [life cycle](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/states.md) section for more details.
...
### 3. How can I pause a Subscription?
     ...
     - [From the Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/pause-resume-cancel.md#pause-subscription-via-the-dashboard).
     - [Using APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/subscriptions.md#pause-a-subscription).
...
### 2. How can I resume a Subscription?
     ...
     - [From the Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/pause-resume-cancel.md#resume-subscription-via-the-dashboard).
     - [Using APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/subscriptions.md#resume-a-subscription).
...
### 1. Can I cancel a Subscription?
     ...
     - [From the Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/pause-resume-cancel.md).
     - [Using APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/subscriptions.md#cancel-a-subscription).
...
### 3. Which banks and apps support UPI Subscriptions?
     ...
     **Supported Banks** 
     ...
     Refer to the [list of banks that support UPI Autopay](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/recurring-payments/upi/supported-banks.md#supported-banks).
...
### 1. Which banks are live on the cards, and what does this mean for businesses?
     ...
     Refer to the [list of banks that support cards](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/supported-banks-apps.md#cards).
...
### 4. What happens to debits of Subscriptions plans of banks that are not live by September 30, 2021?
     ...
     **Alternate Approach** - Register for a new Subscription
     ...
     Refer to the [Subscriptions document](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions.md) for more information.
...
>      
     ...
     To process debits of amounts above ₹15,000 (upto ₹1,00,000 for [certain merchant categories](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/supported-banks-apps.md#supported-mccs)):
     1. Razorpay will initiate the debit 36 hours before the actual debit date.
...
### 6. How long does it take to process UPI payments?
     ...
     ***** Due to [payment retries](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/payment-retries.md#retry-model-for-upi), this may extend to T+1.
...
>      **Handy Tips**
> 
>      For certain MCCs, the maximum amount limit for one transaction is ₹1,00,000. Refer to the [the list of supported MCCs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/supported-banks-apps.md#supported-mccs), issuing banks and PSP applications.
>      
...
### 20. Is QR Code supported for UPI Autopay?
     ...
     Yes, [QR Code](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/qr-codes.md) is supported on Standard Checkout to collect Subscription payments. The customers can scan the QR using any PSP app and make the payment.
...
### 4. Which banks have enabled Subscription through Emandate?
     ...
     Currently, Subscription through Emandate is available for a few banks. Refer to the [Supported Banks and Apps](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/supported-banks-apps.md) page for more information.
...
### 11. Which authentication type is supported for the Aadhaar based authentication?
     ...
     Razorpay supports eSign as an [authentication type](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/supported-banks-apps.md#emandate) for the Aadhaar authentication.
...
### 1. When can I link an offer to a Subscription?
     ...
     know more about [Subscription Offers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/offers.md).
...
### 6. Can I link an offer to a Subscription after it has gone live?
     ...
     Yes. You can [link an offer to a Subscription after it has gone live](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/offers/link.md#link-offer-to-an-existing-subscription).
...
### 1. Can I accept Subscription payments in currencies other than INR?
     ...
     Yes. You can accept Subscription payments in any of the [supported currencies](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments.md#supported-currencies).
...
### 2. In what currency are international payments settled?
     ...
     Refer to our [International Payments page](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments.md) for more details.
