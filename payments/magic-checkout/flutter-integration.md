...
- Generate [API Keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings.md#api-keys) from the Dashboard. To go live with the integration and start accepting real payments, generate Live Mode API Keys and replace them in the integration.
...
: `string` The currency in which the transaction should be made. See the [list of supported currencies](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments.md#supported-currencies). Default is `INR`. Length must be of 3 characters.
...
Know more about [UPI Intent and its benefits](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/upi/upi-intent.md).
...
> 
        ...
        Fetch an Order
         ...
         Know more about the [Orders API.](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/orders.md)
...
### Fetch a Payment
         ...
         Know more about the [Payments API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments.md).
...
### Supported Payment Methods
        ...
        ---
        [Cash on Delivery](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/cod.md)  | `cod` | Requires [Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/cod.md#prerequisites).
        ---
        ...
        Check the following lists: 
            - [Supported UPI Flows](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/upi.md).
            - [UPI Error Codes](https://raw.githubusercontent.com/razorpay/markdown-docs/master/errors/payments/upi.md).
...
>         
        ...
        Check the following lists: 
            ...
            - [Test Error Scenarios](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payments/test-card-details.md#error-scenario-test-cards).
...
[Flutter Standard Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/flutter-integration/standard.md)
