...
### Prerequisites
         ...
         2. Integrate with [Razorpay Flutter Standard Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/flutter-integration/standard/integration-steps.md).
...
- `SERVER_ERROR`: Failure at PSP.
         ...
         [Refer to the list of possible error reasons](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/flutter-integration/standard/payment-methods/turbo-upi/error-codes.md).
