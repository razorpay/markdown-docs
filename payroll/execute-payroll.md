...
Once you complete [Payroll account setup](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/quickstart.md), you can execute payroll for your organisation. Payroll automates transactions and manages payroll as per settings enabled. Use the following checklist to execute payroll without any misses.
...
- If you are tracking the loss of pay (LOP) days outside of Payroll or using the [Jibble integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/integrations/jibble.md), follow the given steps:  

    
        Know how to [sync loss of pay data from Jibble](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/integrations/jibble.md#verify-lop-in-payroll).
...
Check how you can modify other salary components as part of [Run Payroll](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/run-payroll.md).
...
Finalise the payroll for the month. [Transfer the funds](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/payroll-payouts.md) required to process payroll and then **Request Execution** with ease. You **cannot** [make changes](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/exceptional-cases.md) to payroll after you have executed it. 

Authorise the payroll execution using the OTP received at your registered email address/authenticator app.

### Related Information

- [Run Payroll](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/run-payroll.md)
