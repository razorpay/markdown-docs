...
You should add Linked Accounts using [Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/linked-account.md#add-and-manage-linked-accounts).
...
1. After login, you should add linked accounts to start using Route. Refer to the [Linked Accounts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/linked-account.md) page for more information.
...
Know more about [Route](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route.md) and the [Dashboard actions](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/batch-upload.md).

### Related information

[Route Use Cases](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/use-cases.md)
