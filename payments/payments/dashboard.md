...
You can issue refunds to your customers from the Dashboard. Know more about [issuing refunds](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/refunds/issue.md).

## Subscribe to Webhook Events

You can subscribe to webhook events from the Dashboard. Know more about [Webhooks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks.md).
...
Know more about [webhooks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks.md) and check the [sample payloads](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/payments.md).

### Related Information 

- [About Payments](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payments.md)
- [Payment APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payments/apis.md)
