...
After you log in to your [Payroll Dashboard](https://payroll.razorpay.com/dashboard) as an admin, add balance to your account to start making payroll payouts. You can also create and assign [user roles](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/user-roles-workflows.md) and [create Approval Workflows](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/approval-workflow.md) to permit or restrict access.
...
> **Handy Tips**
> 
> Explore the RazorpayX - Current Account [integration with Payroll](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/integrations/current-account.md) to simplify money transfer and fund management. 
> 
...
### Fund Transfer Best Practices
         ...
         - You are transferring funds from a **whitelisted account**. 
            ...
            [Contact support](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/plans.md#contact-support) to initiate SAV for your organisation.
         - You transfer funds via IMPS. 

            IMPS is a reliable payment mode that is available 24/7 on all non-working days and bank holidays. Know more about the [default payment mode](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/payroll-payouts.md#modify-default-payout-mode).
...
### Fund Credit Not Updated
         ...
         Balance updates can be delayed if: 
            ...
            If you have transferred funds to Payroll and your balance does not reflect the amount, raise a [support ticket](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/plans.md). Include the funds transfer's receipt that shows the following details:
...
If you have any queries, raise a [support request](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/support.md#razorpayx-payroll).

## Make Payroll Payouts 

Payroll payouts happen after you [execute payroll](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/run-payroll.md#execute-payroll). Following are some options and best practices available to you when making payroll payouts. 
...
### Modify Default Payout Mode
         ...
         Payroll by default uses IMPS for any payout. IMPS is available 24/7 and works on all days, irrespective of whether it is a bank holiday or a weekend. 
            ...
            - If your employee has chosen NEFT transfers under their [Payments Information](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/employees.md) setup.
...
When you pay [contractors](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/administrator.md#differences-between-employee-and-contractor/) on the Payroll Dashboard, charges for the payments are not immediately deducted. You instead receive a consolidated monthly invoice for all the payments. 
...
- [Account Setup Guide](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/quickstart.md)
- [Statutory Compliance](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/statutory-compliance.md)
