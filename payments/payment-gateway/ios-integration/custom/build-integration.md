...
- API key. You can generate this from the [Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings.md#api-keys).
...
You can accept payments through UPI, credit/debit cards, netbanking and wallets, depending on the methods enabled for your account. When you use [Razorpay iOS Standard SDK](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/ios-integration/standard.md), you do not have to handle the availability of different payment methods. However, when creating a custom checkout form, ensure the display of only the methods activated for your account to the customer.
...
> 
> **Action Required:**
> - If you are a new Razorpay user, use [UPI Intent](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/custom/payment-methods.md#intent-flow). 
...
[Step 2: Test Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/ios-integration/custom/test-integration.md)
