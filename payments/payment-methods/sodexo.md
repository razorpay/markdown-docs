...
### Step 1: Enable Optimizer and Add PayU as Payment Provider
         ...
         1. Enable [Optimizer](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/optimizer.md) on your Razorpay account.
         2. Log in to the Dashboard and navigate to **Optimizer**.
         3. [Add PayU as a payment provider](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/optimizer/payu.md#add-payu-as-a-payment-provider).
...
### Step 2: Configure Sodexo as a Payment Method
         ...
         2. Select **Sodexo** from the list of payment methods and click **Request**. Know more about [how to request for a payment method](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/payment-methods.md#request-for-payment-methods).
