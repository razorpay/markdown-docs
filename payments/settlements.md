...
- Your account must be fully activated for payments to be settled to your bank account. Know more about [KYC Verification](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/set-up.md#2-submit-kyc-details).
- The payment must be captured. Know more about [capturing payments](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payments/capture-settings.md).

## Settlement Cycle

We automatically settle captured payments to the bank account you submitted to us during your [KYC verification](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/set-up.md#2-submit-kyc-details) following our settlement cycle. The settlement cycle is subject to bank approval and can vary based on your business vertical, risk factors and so on.
...
Razorpay allows you to accept payments in any of the [supported international currencies](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments.md#supported-currencies).
...
- [View settlement details](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/settlements/dashboard.md#view-settlements-using-dashboard)
- [Check settlements break-up](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/settlements/dashboard.md#settlements-break-up-description)
- [Enable settlements on hold](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/settlements/dashboard.md#enable-settlements-placed-on-hold)
- [View reports related to settlements](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/settlements/dashboard.md#reports)

### Related Information

- [Settlements APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/settlements/apis.md)
