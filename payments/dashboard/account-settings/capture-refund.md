...
- [Auto-capture all payments](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payments/capture-settings.md#auto-capture-all-payments)
- [Auto-capture with set timeouts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payments/capture-settings.md#auto-capture-with-custom-timeouts)
- [Manually capture timeout](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payments/capture-settings.md#manual-capture-timeout)

## Choose Refund Speed

You can make Normal Refunds or Instant Refunds. You can also issue refunds in batches. Know more about [Refunds](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/refunds.md).
