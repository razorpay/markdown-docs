...
`customer_id`
: `string` This is the Razorpay customer id. You can create token for a specific customer using their customer id. Use the [Customers API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/customers.md) to create customer id.
...
- [Customers API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/customers.md)
- [Orders API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/orders.md)
- [Server-to-Server JSON V2 Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/s2s-integration/json/v2.md)
