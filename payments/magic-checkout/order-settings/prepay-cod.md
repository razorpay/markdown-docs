...
> - This feature is available only if you use [Shopify](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/shopify.md) or [WooCommerce](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/woocommerce.md) (v4.3.5 and above) plugin.
> 
...
> 
>     The **Enable conversion for** field will appear if you enable the [Manually review COD orders](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/order-settings/review-cod-orders.md) feature. The COD conversion will be based on the type of RTO risk.
>         
>     
