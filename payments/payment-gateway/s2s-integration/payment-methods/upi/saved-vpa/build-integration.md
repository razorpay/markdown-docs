...
-  Poll the Razorpay servers to [fetch a payment](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/fetch-with-id.md) or [fetch the payments made for an order](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments.md#fetch-payments-based-on-orders).

- Subscribe to [payments](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/payments.md) and [orders](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/orders.md) Webhook events that are generated in Razorpay when the customer completes the payment on your website.
