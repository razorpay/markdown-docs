...
After you [set up and configure](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/tally/set-up.md) the integration, you can send your [Payment Vouchers](#send-and-sync-payment-vouchers-to-razorpayx) to RazorpayX and sync them for reconciliation. 
...
Go to RazorpayX and pay your invoices as per the standard [vendor payment flow](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments.md).
...
All the payments made can be brought back to Tally. Know more about [bringing bills to Tally](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/tally/bring-bills.md) from RazorpayX.
