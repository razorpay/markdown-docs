...
### 1.1 Create an Order in Server
         ...
         - You can create an order using the [Orders API](#api-sample-code). It is a server-side API call.  Know how to [authenticate](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#generate-api-keys) Orders API.  
...
>          **Handy Tips**
> 
>          You can capture payments automatically with one-time [Payment Capture setting configuration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/server-integration/php/integration-steps.md#3-go-live-checklist) on the Dashboard.
>          
...
> 
>                      1. Edit the `[KEY_ID]` inside the html file. Use the test keys while testing your application.  Know how to [Generate API keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#generate-api-keys).  
>                      2. Edit the `[KEY_ID]` and `[KEY_SECRET]` in **config.php**. 

> 
>                   - Test your integration using these [test cards](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/server-integration/php/integration-steps.md#2-test-integration).
> 
>                   
...
Razorpay offers a range of [payment products](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments.md) to meet your business requirements. Visit our [GitHub repository](https://github.com/razorpay/razorpay-php) for sample codes.
...
[Troubleshooting and FAQs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/server-integration/php/troubleshooting-faqs.md)
