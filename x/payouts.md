...
A payout transaction is made to a [Fund account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/fund-accounts.md) associated with a [Contact](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/contacts.md). Contact is the beneficiary (person or institution) and Fund account is the account used for payment transactions.
...
> **What's New**
> 
> You can now initiate payouts directly to mobile numbers using the [Payout Composite API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/payout-composite/create/phone-number.md). This feature is currently not available on dashboard.
> 
...
### Features and Functions
            ...
            Payouts in RazorpayX come with variety of features and functions. You can:
                ...
                - [Make payouts in Test Mode](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/dashboard/test-mode.md#payouts) to understand the payout process and life cycle.

            If a payout fails at any stage, [a reversal is created](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/states-life-cycle.md#reversal-transaction), which ends with the debited balance being credited back to your RazorpayX account.

            The payout amount, fees and tax are deducted from your RazorpayX account balance. These appear as a debit against your RazorpayX account. Know more about [Billing in RazorpayX](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/manage-teams/billing.md).
...
2. Create a Contact and a Fund account. This is similar to adding a beneficiary on your netbanking portal. Know more about adding [Contacts and Fund accounts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/contacts.md).
3. Make a payout.
...
3. Select an existing contact or [create a new one](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/contacts.md#create-a-contact).
4. Hover over the fund account to which you want to make the payout and click **NEXT** or [**+ FUND ACCOUNT**](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/fund-accounts.md#update-a-contact-and-fund-account) as per requirement.
...
You can cancel the payouts in a [`queued`](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/states-life-cycle.md#queued), [`pending`](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/states-life-cycle.md#pending) or [`scheduled`](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/states-life-cycle.md#scheduled) state only.
...
Know more about creating [payouts using APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/payouts.md) and [payouts in bulk](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/contacts/bulk-uploads.md).
...
### RazorpayX Lite
         ...
         The transaction limits and operating hours for different payout modes for [RazorpayX Lite](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/account-types.md#virtual-account) are as below:
...
### Current Account
         ...
         The transaction limits and operating hours for different payout modes for [Current account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/account-types.md#current-account):
...
[Contact support](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/support.md) for enabling **NEFT 24 * 7** in RBL and Yes Bank accounts.
...
- [Payout Life Cycle and States](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/states-life-cycle.md)
- [Payout Status](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/status-details.md)
- [Payout Best Practices](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/best-practices.md)
