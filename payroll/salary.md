...
- Execute monthly payroll using [Run Payroll](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/run-payroll.md). 
- Make [one-time payments](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/one-time-payments.md), as necessary.
- Approve and pay [Reimbursements](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/reimbursements.md).
- Approve and pay Advance Salary.
- Create [bonuses](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/bonus.md) and add clawbacks.
- Grant [employee loans](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/loans.md) at the time of need. 
...
Your employees can upload proof of expenses by going to **Reimbursements** → **Reimburse Flexible Benefits**. After they have uploaded their proofs, you can view the [pending reimbursements](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/reimbursements.md#view-pending-reimbursements).
