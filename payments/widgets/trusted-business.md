...
- Generate the API Keys on the Dashboard. You can use the  [Test Mode keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#live-mode-api-keys) to test the integration and preview the Widget. Later, switch to **Live Mode** on the Dashboard, generate the [Live API keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#live-mode-api-keys) and replace it with the test keys.
- Check if you are [eligible](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/features/trusted-business.md#eligibility-requirements) for Razorpay Trusted Business on the Dashboard. 
...
- Currently, the RTB widget is supported on Web and [shopify](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/widgets/trusted-business/rtb-widget-shopify.md).
