...
3. The payment details appear in the right pane. You can perform the following operations from this tab:
    1. **Create Transfer**: Transfer the payment to a linked account. Know more about [Route](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route.md).
    2. **Create Refund**: Refund the payment to the customer. Know more about [Refunds](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/refunds.md).
     

## What Next
Once you have created the QR Code, you can share the short URL with the customer. You can also print or download it and send the image. You can also choose to [close the QR Code](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/qr-codes/close.md).
...
### Related information
- [QR Code](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/qr-codes.md)
