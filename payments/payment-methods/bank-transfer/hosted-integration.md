...
The bank transfer payment method will appear for the [payment gateway](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/hosted.md) and products such as Payment Links, Payment Pages and Subscriptions.
...
You must subscribe to the `virtual_account.credited` webhook event on the Dashboard to receive notifications whenever customers make payments using bank transfers. Know how to [set up webhooks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks.md#set-up-webhooks).
...
The bank transfer payment method will appear for the [payment gateway](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/hosted.md) and products such as Payment Links, Invoices and Subscriptions.
...
**Read More**: [List of parameters for Hosted Checkout](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/hosted/integration-steps.md#1-build-integration).
