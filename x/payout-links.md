...
RazorpayX then sends them a link where the [Contact](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/contacts.md) can then enter their account details (bank account or UPI ID). Once we get their verified account details, we transfer the amount. 
...
> **Watch Out!**
> 
> - Allowlisting your IP is mandatory for using the Payout Link APIs. Know how to [allowlist your IP](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/dashboard/allowlist-ip.md).
...
1. [Create a Payout Link](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payout-links/create.md) by entering:
...
To do this, [contact support](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/support.md) and request the feature. The configured mode will be used to process all payouts made via links from your account. 
...
- [Create Payout Links](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payout-links/create.md) 
- [Payout Links API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/payout-links.md)
- [Payout Link Life Cycle](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payout-links/life-cycle.md)
