...
> **Note:**
> 
> If you are using an official [Razorpay Language-wise SDK Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/server-integration.md), the error responses result in exceptions that need to be handled in your integration.
> 
...
To understand more about error codes, refer to the [Error Codes](https://raw.githubusercontent.com/razorpay/markdown-docs/master/errors.md) section.
