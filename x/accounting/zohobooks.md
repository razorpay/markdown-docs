...
### General
       ...
       You can choose to disable or enable the following options:
         ...
         - Sync RazorpayX Bank [Account Statement](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/accounting/zohobooks/account-statement.md) to Zoho Books
         - Sync and Categorise [Vendor Payments](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/accounting/zohobooks/vendor-payments.md) from RazorpayX to Zoho Books
         - Sync and Categorise [Payouts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/accounting/zohobooks/payouts.md) from RazorpayX to Zoho Books
