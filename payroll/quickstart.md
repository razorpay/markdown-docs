...
### Add All Employees
           ...
           To add employees:
            ...
            You have successfully added employees/contractors to the Dashboard. Your employees can complete their [onboarding and profile set up](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/employees.md#employee-onboarding) using the welcome mail they receive at their registered email id. 
...
### Enable Compliances
         ...
         Update your organisation's compliance details as applicable. We support and automate many monthly [statutory compliance](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/statutory-compliance.md) payments. 
        ...
        You have successfully enabled the applicable compliances. Know more about [compliance payments and automation](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/statutory-compliance.md). 
...
### Setup Default Salary Structure
         ...
         See [default salary structure](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/salary.md#setup-salary-structure) set up.
        

    
### Check for Missing Information

         Before you [execute payroll](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/execute-payroll.md), ensure you your employees' data is available and up-to-date.
...
### Employee Tax Declarations
         ...
         You must ask your employees to update their tax deductions and declarations on the [Employee Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/employees/declarations.md). 
...
- [Execute Payroll](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/execute-payroll.md)
- [Statutory Compliance](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/statutory-compliance.md)
- [Administrative Role](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/administrator.md)
