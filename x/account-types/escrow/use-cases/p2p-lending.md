...
LSP partners are onboarded as [sub-accounts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/sub-accounts.md) with P2P Escrow as the master account.
...
Connect with your RazorpayX POC or [contact support](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/support.md) for document templates, letters and other supporting material.
...
You can make payouts via your Escrow Account using our [Payout APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/api.md).

Points to remember:

- Ensure to follow all the payout [best practices](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/best-practices.md).
- Contact type must be `borrower` or `investor`. Know more about [Contact APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/contacts/api.md).
- Payout purpose must be `Loan disbursement` or `Investor withdrawal`. Know more about [Payout purpose](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts.md#payout-purpose).
- [Allowlist your IPs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/dashboard/allowlist-ip.md).
