...
> Refer to the [Recurring Payments document](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/recurring-payments.md) for more information on payment methods.
> 
...
> Refer to the [Payment Link document](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-links.md) for more information.
> 
...
Refer to the [Recurring Payments API document](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/recurring-payments/cards/create-authorization-transaction.md#112-create-an-order) for more information on changes.
...
Yes, businesses can cancel card tokens by deleting them. Tokens can be deleted either from the [dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/recurring-payments/create.md#delete-the-token) or using [APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/recurring-payments/cards/tokens.md#23-delete-tokens).
