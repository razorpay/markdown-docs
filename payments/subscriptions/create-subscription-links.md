...
1. [Create a plan](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/create-plans.md#create-a-plan).
1. [Create and send a Subscription link](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/create-subscription-links.md#create-a-subscription-link).
...
You can create a Subscription Links using [Create a Subscription Link API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/subscriptions/create-subscription-link.md).
