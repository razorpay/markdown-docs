...
> **Watch Out!**
> 
> Dynamic Multi-bank Routing is applicable only to payouts made via [Payout APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/payouts.md).
> 
...
1. [Account Statements](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/account-statement.md)
2. [Reports](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/reports.md)
3. [Payouts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/reports.md)

### Related Information

- [About Payouts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts.md)
- [Open a Current Account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/account-types/current-account.md)
