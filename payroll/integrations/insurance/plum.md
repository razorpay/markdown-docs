...
> - [Contractors](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/administrator.md#differences-between-employee-and-contractor) are not covered in the insurance plans. 
> 

## Prerequisites

1. Your organisation must be using RazorpayX Payroll for all the salary transfers and applicable [compliances](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/statutory-compliance.md).
...
- [Income Tax Declaration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/employees.md#income-tax-declaration) 
