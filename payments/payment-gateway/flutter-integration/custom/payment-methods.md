...
View the complete list of [UPI supported apps and their package names](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/upi/supported-apps.md).
...
Given below is the sample code for the payment method `paylater`. Know more about [paylater](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/pay-later/custom-integration.md).
...
Given below is the sample code for the payment method `cardless_emi`. Know more about [Cardless EMI](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/emi/cardless-emi/custom-integration.md).
