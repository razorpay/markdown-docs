...
> **Watch Out!**
> 
> Only the person with [Owner](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/manage-team.md#owner) credentials of the sub-merchant account can authorise the access.
> 
