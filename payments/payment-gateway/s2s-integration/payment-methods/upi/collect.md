...
- [Validate the VPA](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/custom/features/validate-vpa.md) before initiating the payment request.
...
- Use the [Saved VPA](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/s2s-integration/payment-methods/upi/saved-vpa.md) feature offered by Razorpay to provide a better customer experience.
...
: `json object` Key-value pairs that can hold additional information about the payment. 
 Refer to the [Notes](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/understand.md#notes) section of the API Reference Guide.
...
If the payment has failed, the callback will contain details of the error. Refer to [Errors](https://raw.githubusercontent.com/razorpay/markdown-docs/master/errors/payments/payment-methods-error-parameters.md#upi) for details.
...
`currency` _mandatory_
: `string` ISO code for the currency in which you want to accept the payment. Refer the [list of supported currencies](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments.md#supported-currencies).
...
- Poll Razorpay servers periodically for the [payments made for the order](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/orders/fetch-payments.md) using our Fetch Payment APIs.
- Subscribe to the webhook events created in our system for each of the following entities:

  - [payments](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/payments.md)
  - [orders](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/orders.md)
...
- [UPI Error Codes](https://raw.githubusercontent.com/razorpay/markdown-docs/master/errors/payments/payment-methods-error-parameters.md#upi)
