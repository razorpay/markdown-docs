...
- You can add a Contact's name, email id, phone and [Fund Account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/fund-accounts.md) details (bank account, UPI or both) while creating a Contact. 
...
> **Contact Support**
> 
> This page is not meant for contacting Razorpay Support. Visit our [contact support page](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/support.md) to contact our support team.
> 
...
You can [create Contacts using APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/contacts/create.md) or [create Contacts in bulk](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/contacts/bulk-uploads.md).
...
You can also [create](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/contacts/create.md) and [update](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/contacts/update.md) contacts using APIs. 
...
Add [Fund Accounts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/fund-accounts.md).

### Related Information

- [Payouts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts.md)
- [Fund Accounts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/fund-accounts/faqs.md)
