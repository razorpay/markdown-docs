...
Use this API endpoint to create a webhook. Know about the [various error responses](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/partners/errors.md) for this API.
