...
For more information, refer [Standard Checkout](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/standard.md)
...
Refer to the [Fetch Token API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/cards/token-private.md) document for more information.
...
For more information, refer to the [S2S Integration - Tokenisation APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/cards/token-hq/merchant-requestor/apis.md) documentation.
...
### Step 1 - Fetching Customer Tokens
     ...
     To be able to create tokens using Push Tokenisation, you must create a customer using phone number as the primary identifier. For more details, refer [Create a Customer API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/customers/create.md). 
...
2. Webhook Setup:
    - Watch this [tutorial video](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/setup-edit-payments.md) for detailed steps on setting up the webhook.
