...
### 1.3 Enable Webhooks on the Dashboard
            ...
            [Enable Webhooks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/setup-edit-payments.md#set-up-webhooks) to receive notifications for these events.
...
###  1.6 Verify Payment Status
                ...
                1. Log in to the **WordPress Admin Dashboard** and navigate to **Razorpay Route woocommerce** → **Payments**.
                2. Check if a **Payment Id** has been generated and note the status. In case of a successful payment, the status is marked as **Captured**. Know more about various [payment states](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payments.md#payment-life-cycle).
...
> - Ensure you have entered [Test Mode API keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#generate-api-keys) in the Checkout code.
> 
...
### 3.2 Generate an API Key in Live Mode
         ...
         Watch this video to generate an API Key in Live Mode.
            ...
            You have successfully generated your API keys in Live Mode. Use this pair of `Key_ID` and `Key_Secret` to accept payments from your customers and route them to the involved third parties using [Route](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route.md).
