...
1. Select the **Last working date** (LWD) from the calendar and provide a reason for dismissal. If you have enabled the [resignation module](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/employees/resignation.md), we automatically add the LWD.
...
1. In the **Salary during resignation months** section, select **Hold net pay till the last working month**. You can then select the start month for withholding salary from the **Hold net pay starting from** drop-down menu. 
    ...
    You can select **Release Salary** to process the final settlement as per the regular [employee dismissal](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/resignation.md#process-full-final-settlement) process. 
...
1. This opens the **Full and final settlement** page for the employee. Enter the adjustments as per the usual [employee dismissal](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/resignation.md#process-full-final-settlement) process. 
...
### 1. I am unable to view the dismissal or net pay information of some of my dismissed employees. Why?
            ...
            [Finalise Payroll](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/run-payroll.md#execute-payroll) in **Run Payroll** for the dismissed employee's net pay information to reflect on the RazorpayX Dashboard. 
...
### 2. Does Payroll immediately transfer the net pay after I choose 'Release Salary' when initiating FNF?
         ...
         No, choosing **Release Salary** does not immediately release the employee's net pay. Instead, Payroll processes the employee's [Full and final settlement](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/resignation.md#process-full-final-settlement) as part of the monthly payroll activity. 
...
### 4. What are the supported payment modes to process employee's FNF?
            ...
            We support both NEFT and IMPS payment modes to process employee's full and final settlement. However, we recommend you choose NEFT as your default payment mode. Know more about [payroll payouts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/payroll-payouts.md#make-payroll-payouts).
...
- [Terminate Employee and Run Last Payroll](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/resignation.md#process-full-final-settlement)
