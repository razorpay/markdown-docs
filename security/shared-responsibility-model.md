...
We also provide you with a facility to [generate API keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#generate-api-keys) and connect to our systems via automated computer programmes. Know how Razorpay does [Secret Management](https://razorpay.com/blog/secret-management-razorpay/).
...
You would be responsible for any misuse by not handling keys or the Dashboard credentials securely. We have an intuitive [security checklist](https://raw.githubusercontent.com/razorpay/markdown-docs/master/security/checklist.md) to review the security posture and help you interact with us securely.
...
- [Security Checklist](https://raw.githubusercontent.com/razorpay/markdown-docs/master/security/checklist.md)
