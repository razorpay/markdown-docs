...
>
> **Handy Tips**
 Expiry feature for Payout Links must be enabled before using this webhook event. Know more about how to [enable the expiry feature.](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payout-links/set-expiry.md)
