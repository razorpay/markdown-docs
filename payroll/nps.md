...
1. Enter the employee's 12-digit PRAN in the text box. We pre-fill employee's PRAN if the employee provided their PRAN during [onboarding](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/employees.md#set-up-profile).
1. Click **CONTINUE**. 
...
- Ensure the declaration window is open during [onboarding](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/employees.md#employee-onboarding) and [salary revision](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/run-payroll.md#revise-salary) process.
...
- [Employee NPS Declaration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payroll/employees/declarations/nps.md)
