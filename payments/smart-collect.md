...
> **Handy Tips**
> 
> - Understand the Razorpay [payment flow](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/how-it-works.md) that Smart Collect follows to collect payments.
> - Smart Collect also supports [Third-Party Validation (TPV)](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/smart-collect/third-party-validation.md).
> 
> 
...
### Smart Collect Use Cases
        ...
        Explore the [Smart Collect Use Cases](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/smart-collect/use-cases.md) to gain deeper insights into the capabilities and practical applications of Smart Collect and Smart Collect 2.0.
...
## Prerequisites
        ...
        2. Read and understand the [pricing model](https://razorpay.com/smart-collect/#pricing) and have the [API documentation](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/smart-collect.md) for Smart Collect handy. 
        ...
        5. Do check the [list of banks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/third-party-validation/bank-list.md#list-of-banks-supporting-tpv-for-smart-collect) which support Smart Collect with TPV.
    
    
        1. You must open a [Current account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/account-types/current-account.md)/[Escrow account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/account-types/escrow.md). We enable you in this process. 
...
- [Customer Identifier States](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/smart-collect/states.md)
- [Auto Third Party Validation (TPV) on Smart Collect](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/smart-collect/third-party-validation.md)
- [Smart Collect APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/smart-collect.md)
- [Subscribe to Webhooks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/smart-collect/subscribe-to-webhooks.md)
