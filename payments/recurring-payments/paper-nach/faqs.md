...
### 1. How can I create physical mandates?
         ...
         You can generate and submit physical mandates from the [Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/recurring-payments/create.md) or [using our APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/recurring-payments.md).
