...
> - The Dashboard has [test and live modes](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/test-live-modes.md). Use the test mode for a sandbox experience. You can switch to live mode when you are ready to accept payments. You will have to create a new Webstore in live mode.
...
5. You can also configure Facebook Pixel and Google Analytics for your Webstore for metrics. Know more about how to add [Facebook Pixel and Google Analytics](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/webstore/plugins-add-ons.md) to your Webstore.
6. Click **Save**.
