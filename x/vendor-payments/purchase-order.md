...
Before creating your first Purchase Order, set your **Billing Address** via [Branches](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/multi-branch-management.md) that will appear on the header of the Purchase Order. You can add only 1 billing address.
