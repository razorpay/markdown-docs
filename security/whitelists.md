...
We highly recommend using [Webhook Signature](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks.md#validation) to validate the integrity of the webhooks, even if you have whitelisted our Webhook IPs.
