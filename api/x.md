...
Know more about [API parameters](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/apis.md).
...
Know more about [Test Mode](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/dashboard/test-mode.md).
...
## Webhooks
[Set up Payout Webhooks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/setup-edit-payouts.md)to configure and receive notifications when a [specific event occurs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks.md#available-events). When one of these events is triggered, we send an HTTP POST [payload](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks.md) in JSON to the webhook's configured URL.

### Related Information

- [Set up your RazorpayX account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/set-up.md)
- [RazorpayX Account Types](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/account-types.md)
