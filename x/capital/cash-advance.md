...
1. Follow these steps to apply for a [Line of Credit](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/capital/line-of-credit.md#apply-for-line-of-credit). The process is the same. 
...
This happens on a daily basis and we recommend this for businesses using other [Razorpay products](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments.md).
...
> **Watch Out!**
> 
> We only deduct from your Razorpay [settlement's current balance](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/settlements/dashboard.md#view-settlements-using-dashboard) and not your linked bank account.
> 
...
1. You can do either of the following:
            ...
            1. Select between your Razorpay [settlement's current balance](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/settlements/dashboard.md#view-settlements-using-dashboard) for us to deduct your instalment amount or pay using UPI/Debit Card/Netbanking. 
...
---
`failed` | Sometimes, your disbursal or repayments may fail due to unavoidable server downtimes. Retry the withdrawal/repayment process. You can [contact support](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/support.md#razorpayx-capital) from the RazorpayX Dashboard for any queries. 
---
...
### 9. My question is not answered here.
         ...
         [Raise a request](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/support.md#raise-a-new-ticket) from your [RazorpayX Dashboard](https://x.razorpay.com/auth) in case of any queries.
        

#### Related Information

- [Razorpay Capital Use Cases](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/capital/line-of-credit.md#use-cases)
