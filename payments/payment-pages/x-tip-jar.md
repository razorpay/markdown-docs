...
- [Set up](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/set-up.md) your Razorpay account and complete the KYC process.
- Create a [Payment Page](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-pages/create.md) and copy the page URL. If you already have a Payment Page, follow the steps given below.
