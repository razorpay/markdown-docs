...
> **Watch Out!**
> 
> You can access the **COD Orders Review Workflow** feature only if you opt for [manual review of COD orders](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/order-settings/review-cod-orders.md). 
> 
...
>              **Handy Tips**
>             
>              This feature is available for your Custom ecommerce platform, [WooCommerce website](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-pages.md) and [Shopify store](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-pages.md).
>              
