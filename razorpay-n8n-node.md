...
View [Complete Operations Reference](https://raw.githubusercontent.com/razorpay/markdown-docs/master/razorpay-n8n-node/operations-reference.md).
...
> 
> Access **28 additional operations** via [Razorpay MCP Server](https://raw.githubusercontent.com/razorpay/markdown-docs/master/mcp-server.md) integration.
> 
...
View [Use Cases](https://raw.githubusercontent.com/razorpay/markdown-docs/master/razorpay-n8n-node/use-cases.md).
...
### Razorpay Account
     ...
     - **API Keys**: Generate [API keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/api-keys.md) from the Razorpay Dashboard.
...
1. **[Install the Node](https://raw.githubusercontent.com/razorpay/markdown-docs/master/razorpay-n8n-node/installation.md)**: Add Razorpay node to your n8n instance.
2. **Configure Credentials**: Generate and add your API keys.
3. **[Explore Use Cases](https://raw.githubusercontent.com/razorpay/markdown-docs/master/razorpay-n8n-node/use-cases.md)**: Learn from real-world examples.
4. **Build Your Workflow**: Start with a simple automation.
5. **[Troubleshoot Issues](https://raw.githubusercontent.com/razorpay/markdown-docs/master/razorpay-n8n-node/troubleshooting-faqs.md)**: Resolve common problems.

### Related Documentation

- [Razorpay API Reference](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api.md)
- [Webhook Integration Guide](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks.md)
- [Test Card Details](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payments/test-card-details.md)
- [MCP Server Documentation](https://raw.githubusercontent.com/razorpay/markdown-docs/master/mcp-server.md)
