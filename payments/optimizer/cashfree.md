...
> **Handy Tips**
> 
> Cashfree supports [Third-Party Validation (TPV)](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/optimizer/third-party-validation.md#supported-bank-gateways-payment-gateways-and-payment-methods).
> 
...
You might be generating a unique Order ID or Receipt for every order which can be passed to Cashfree via [Orders API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/orders.md#orders-api). 
