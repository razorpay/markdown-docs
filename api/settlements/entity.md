...
`status`
: `string` Indicates the [state of the settlement](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/settlements.md#settlement-states). Possible values:
  - `created`
  - `processed`
  - `failed`
