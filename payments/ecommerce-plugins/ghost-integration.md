...
### How It Works
         ...
         2. Razorpay detects a `payment.captured` [webhook event](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/payments.md).
...
1. Set up your [Razorpay Webhook](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/setup-edit-payments.md). 
    - You will need the [Zapier **Catch Hook** URL](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/ecommerce-plugins/ghost-integration/zapier-integration.md)to complete the webhook set up. 
...
2. Create a [Razorpay Payment Button](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/ecommerce-plugins/ghost-integration/add-payment-button.md).
...
4. Create a [Zapier Zap](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/ecommerce-plugins/ghost-integration/zapier-integration.md).
...
- [Zapier Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/ecommerce-plugins/ghost-integration/zapier-integration.md)
- [Integrate a Payment Button with Ghost](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/ecommerce-plugins/ghost-integration/add-payment-button.md)
- [Razorpay Payment Button](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-button.md)
- [Razorpay Webhook](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/setup-edit-payments.md)
