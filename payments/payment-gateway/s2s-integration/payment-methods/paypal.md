...
You can accept payments based on the transaction limit of your PayPal account. Know more about the other [payment methods and the transaction limits](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/transaction-limits.md).
...
> **Watch Out!**
> 
> You can accept payments from the provided [list of supported currencies](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/s2s-integration/payment-methods/paypal/supported-currencies.md).
> 
...
: `string` The currency in which the transaction should be made. Refer to the [list of supported currencies](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/s2s-integration/payment-methods/paypal/supported-currencies.md). Length must be of 3 characters.
...
1. Refunds can be initiated by you either from the [Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payments/dashboard.md#issue-refunds) .
