...
### 1. How do I integrate Razorpay Secure with my Shopify store?
         ...
         Follow the [build integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/ecommerce-plugins/shopify-razorpay-secure/integration-steps.md#1-build-integration) steps to integrate Razorpay Secure with your Shopify store.
...
### 8. My customer is getting the following error when they make payments on my Shopify store, "There was an issue processing your payment. Try again or use a different payment method." What should I do?
         ...
         Follow the [build integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/ecommerce-plugins/shopify-razorpay-secure/integration-steps.md#1-build-integration) steps to install the plugin again. 
