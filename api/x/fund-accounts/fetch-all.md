...
: `string` The fund account type to be retrieved. Possible values:
    - `bank_account`
    - `vpa`
    - `card` (if [payouts to cards](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/cards.md) is enabled on your account)
...
* solution: Re-check or find the Fund Account ID: - In the response body of [create a Fund Account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/fund-accounts.md) API.
