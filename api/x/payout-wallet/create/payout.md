...
Use this endpoint to create a payout to a wallet. You cannot enter a custom narration when creating a payout via Amazon Pay. Know more about [RazorpayX Payout API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/payouts.md).
...
: `string` The status of the payout. Possible payout states:
  ...
  Refer to [Payout Life Cycle](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/states-life-cycle.md).
