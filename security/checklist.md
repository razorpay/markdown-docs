...
- Implement [Two-Factor Authentication (2FA)](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/manage-team.md#2-step-verification-team-level) across your team for additional security.
...
- The [Razorpay API secret](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#generate-api-keys) is not included in the final Android or iOS build.
...
While integrating with our [Payments API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments.md), ensure that you:
- Use the [Capture a Payment API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments.md#capture-a-payment) to assert the payment status.
- Fetch the amounts of captured payments only from the backend or a trusted source.

### Orders API

While integrating with our [Orders API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/orders.md), ensure that:

- [Payments are auto-captured](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payments/capture-settings.md#auto-capture-all-payments) from the Dashboard.
...
- [Razorpay IPs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/security/whitelists.md#webhook-ips) are added to all the whitelisted webhook requests.
...
- Define [user roles](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/manage-team.md#standard-user-roles) for team members based on their usage of the Dashboard.
- Implement [Two-Factor Authentication (2FA)](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/manage-team.md#2-step-verification-team-level) on all your Razorpay accounts.
- Never share Razorpay Two-Factor Authentication OTPs among employees.

### Related Information

- [Razorpay Security](https://raw.githubusercontent.com/razorpay/markdown-docs/master/security.md)
- [Shared Responsibility Model](https://raw.githubusercontent.com/razorpay/markdown-docs/master/security/shared-responsibility-model.md)
