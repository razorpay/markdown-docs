...
Know [how to integrate saved cards at Standard Checkout.](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/cards/features/integrate-saved-cards.md)
...
3. They enter the OTP sent to their phone or use their fingerprint if [Biometric Authentication](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/features.md) biometric authentication is set up, then click **Verify**.
