...
> - Use the [Dispute Manager](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/manage-team.md#dispute-manager) role for team members who only need to handle chargebacks without access to refunds or bank details.
> - Use the [Pseudo Owner](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/manage-team.md#pseudo-owner) role sparingly for trusted individuals who need to manage the account when the Owner is unavailable.
> - Use the [View-Only](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/manage-team.md#view-only-auditor) role for auditors and stakeholders who need visibility without operational access.
> 
