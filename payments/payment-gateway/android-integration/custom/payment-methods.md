...
Check the [list of supported cards](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/standard/configure-payment-methods/supported-methods.md#supported-cards).

If you want to securely store customer's card details as network tokens, know about [Saved Cards feature](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/custom/features/saved-cards.md).
...
Check the [list of supported Cardless EMI providers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/emi/cardless-emi.md#supported-payment-partners).
...
Check the [list of Pay Later providers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/pay-later.md#providers).
...
Check the list [Wallets supported by Razorpay](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/wallets.md#supported-wallets).
...
Check the complete list of [UPI supported apps and their package names](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/upi/supported-apps.md).
...
1. [Turbo UPI Headless Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-noui.md)
2. [Turbo UPI UI Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui.md)

Know more about the [Customer Onboarding](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi.md).
