...
- Ensure to have a banking account after successful [KYC verification](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/set-up.md#kyc-verification).
