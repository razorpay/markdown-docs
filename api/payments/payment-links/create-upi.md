...
You can [customise Payment Links](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-links/customise.md) as per your business requirements.
...
- After successful completion of the payment, customers can be redirected to a specific URL using the `callback_url` and `callback_method` parameters. Know more about how to use [these paramaters](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/payment-links.md#using-callback-url-parameter).

- Verify the `razorpay_signature` parameter to validate that it is authentic and sent from Razorpay servers. Know more about how to [Verify Signature](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/payment-links.md#verify-signature).
...
`currency` _optional_
: `string` A three-letter ISO code for the currency in which you want to accept the payment. For example, INR. Refer to the list of [supported currencies](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments.md#supported-currencies).
...
: `boolean` Used to send [reminders](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-links/reminders.md) for the Payment Link. Possible values:
...
`accept_partial` 
: `boolean` Indicates whether customers can make [partial payments](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-links/partial-payments.md) using the Payment Link. Possible values:
...
`currency`
: `string` Defaults to INR. We accept payments in [international currencies.](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments.md#supported-currencies)
...
* solution: Ensure that the input fields are added correctly. Refer to these [request parameters](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/payment-links.md#request-parameters) on how to add correct input fields.
...
* solution: Ensure that you use [Live API keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#live-mode-api-keys) while passing UPI links.
