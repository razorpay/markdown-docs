...
Follow these steps to integrate with [Turbo UPI Headless](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-noui.md#1-integration-steps).
...
### 2.5.7 Transactions
                        ...
                        Payments Successful
                         ...
                         1. Begin by following the [integration steps](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-noui.md#1-integration-steps), specifically the `submit` method.
...
Complete this [Go-live Checklist](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-noui.md#3-go-live-checklist) to take your integration live.
