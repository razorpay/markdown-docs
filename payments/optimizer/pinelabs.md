...
You might be generating a unique Order ID or Receipt for every order which can be passed to PineLabs via [Orders API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/orders.md#orders-api).
