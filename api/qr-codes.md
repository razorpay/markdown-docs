...
You can use Razorpay [QR Codes](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/qr-codes.md) to create QR Codes and share them with customers to accept digital payments. You can create and manage QR Codes using APIs or from the [Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/qr-codes/create.md).

 
Refer to the [QR Code Flow](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/qr-codes/how-it-works.md) and [Integration Checklist](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/qr-codes/apis.md#integration-checklist) before you begin integrating with the APIs for QR Codes.

 Fork the Razorpay Postman Public Workspace and try the QR Codes APIs using your [Test API Keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/api-keys.md#generate-api-keys).
...
[About QR Codes](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/qr-codes.md)
