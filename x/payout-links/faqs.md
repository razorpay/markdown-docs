...
### 1. Is the Payout Link supported in test mode?
         ...
         No, currently it is not supported in [Test mode](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/dashboard/test-mode.md). You can only make requests or designate links in Live mode.
...
### 2. What are the supported modes for creating Payout Links?
         ...
         You can create Payout Links via:
            - [Payout Link APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/payout-links.md).
            - [RazorpayX Dashboard](https://x.razorpay.com/).
            - [Bulk upload feature](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payout-links/bulk.md).
...
### 4. Is the maker-checker applicable for Payout Links?
         ...
         Yes, if the [maker-checker](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/manage-teams/approval-workflow.md) is enabled on the account, then it will be applicable. 
...
### 7. If a new link is issued to an old customer, will the customer need to enter the fund account details again?
         ...
         You can manually [resend the Payout Link](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payout-links/create.md#create-a-payout-link) from the Payout Link summary pop-up page. 
        

    
### 8. Can a Payout link be cancelled?

         If the Fund Account details are incorrect or the Payout Link is no longer relevant, you can cancel the Payout Link via the [Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payout-links/create.md#other-actions) or by using the [Cancel a Payout Link API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/payout-links/cancel.md).

         Only Payout Links in the `issued` state can be cancelled. Know more about [Payout Link Statuses](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payout-links/life-cycle.md). If [Approval Workflow](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/manage-teams/approval-workflow.md) is enabled, [cancel the Payout](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts.md#cancel-payouts) first and then the Payout Link. 
...
### 11. Does the Payout Link support an expiry time?
         ...
         Yes, you can [set expiry](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payout-links/set-expiry.md#set-expiry) date and time on the Payout Link.
...
### 14. Is IP Allowlisting mandatory for creating Payout Links?
        ...
        [Allowlisting your IP](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/dashboard/allowlist-ip.md) addresses is mandatory for creating Payout Links through APIs. However, it is not mandatory for creating Payout Links through the Dashboard.
...
### 2. How can I set expiry for Bulk Payout Links?
         ...
         To set expiry for Bulk Payout Links, you must [enable expiry](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payout-links/set-expiry.md#enable-expiry) on the RazorpayX Dashboard. You can then [set expiry](/x/payout-links/bulk#how-it-works) for bulk Payout Links in the sample template.
