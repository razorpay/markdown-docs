...
- Make a payout to an existing [fund account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/fund-accounts.md). 
- Create a new [contact and fund account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/fund-accounts.md#create-a-contact-with-fund-account) to make a payout.

Alternatively, you can also [create contacts and fund accounts in bulk](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/contacts/bulk-uploads.md). 
...
10. Click **Next** to make the payouts or [schedule the payouts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/scheduled.md).
...
---
Incorrect format of the file | Download and fill from the [templates](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/bulk-payouts.md#bulk-payouts-templates) provided.
---
...
>
> **Example**
If you have chosen `Razorpay Fund Account ID` details along with `UPI` as the payout method, the [Fund Account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/fund-accounts.md) ID provided by Razorpay for the respective contact must be linked to a UPI account.
...
You can select the template based on the payment method and the beneficiary to whom you want to credit the amount. Know more about the [payout modes, processing time and amount limit](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts.md#payout-modes-and-tat).
...
- [Bulk Upload Status](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/bulk-payouts/uploads.md)
- [Bulk Payouts Life Cycle](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/bulk-payouts/life-cycle.md)
