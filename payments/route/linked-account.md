...
### Features
        ...
        - [Process individual and bulk refunds](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/linked-account/initiate-refund.md).
        - [View reversals and settlements](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/linked-account/reversals-settlements.md).
        - [Manage profile and team members](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/linked-account/manage-profile.md).
...
>         
        ...
        Create Linked Accounts programmatically using the [Route APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/route.md) for automated onboarding and bulk operations.
...
Know more about [penny testing](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/faqs.md#penny-testing).
...
- [Route Overview](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route.md)
- [Processing Refunds](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/linked-account/initiate-refund.md)
- [Settlements and Reversals](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/linked-account/reversals-settlements.md)
- [Profile Management](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/linked-account/manage-profile.md)
- [Route APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/route.md)
