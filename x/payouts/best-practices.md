...
1. Create a [Contact](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/contacts/create.md). You receive a Contact id in the response.
1. Create a Fund account using the Contact id. The Fund account can be a [bank account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/fund-accounts/create/bank-account.md) or [VPA](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/fund-accounts/create/vpa.md).
1. Create a Payout to [bank account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/payouts/create/bank-account.md) or [VPA](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/payouts/create/vpa.md) using the Fund account id.
...
Know more about [payout states and life cycle](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/states-life-cycle.md).
...
- We recommend subscribing to our [webhooks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/apis/subscribe.md) to get instant notifications. Webhooks are triggered whenever there is a change in the status of the payout. You can update your database using the webhook payload.

## Others Guidelines

### Fund Account Validation

Always validate your customer's Fund account to ensure it is the account number where your user wants to receive the amount. Know more about [Fund account validation](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/account-validation.md). 
...
> **Watch Out!**
> 
> [Idempotency key](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/payout-idempotency/make-request.md) is mandatory to make a successful payout.
> 
...
Know more about [Handling 5XX Errors](https://raw.githubusercontent.com/razorpay/markdown-docs/master/errors/x.md#handling-5xx-errors) and [Idempotency](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/payout-idempotency/make-request.md).

### IP Allowlisting

It is mandatory to [get your IP address allowlisted](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/dashboard/allowlist-ip.md). This means we will process the API calls made from the allowlisted IPs only.
...
- [Payout Status Details](https://raw.githubusercontent.com/razorpay/markdown-docs/master/errors/x/payout-status-details.md)
