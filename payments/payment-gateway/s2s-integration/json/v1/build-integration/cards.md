...
`currency` _mandatory_
: `string` Currency code for the currency in which you want to accept the payment. For example, INR. Refer to the [list of supported currencies](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments.md#supported-currencies). Length must be of 3 characters.
...
If you are using this endpoint to implement [native OTP](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/cards/authentication/native-otp.md) on your website, you can pass the following additional request parameters.
...
> **Watch Out!**
> 
> The OTP Submit and Resend APIs return a response in a particular [format](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/cards/authentication/native-otp.md#4-otp-authentication). A payment that is successfully authenticated in this manner need not be verified.
> 
...
If the payment has failed, the callback will contain details of the error. Refer to [errors](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api.md#errors) for details.
...
[Step 2: Test Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/s2s-integration/json/v1/test-integration.md)
