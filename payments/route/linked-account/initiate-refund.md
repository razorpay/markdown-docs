...
The Linked Account holders must send an offline request to you to use [Refund Credits](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/linked-account.md#enable-refund-credits). Upon gaining access, funds can be transferred to the Refund Credits pool through the account number that you share.
...
You can initiate the following types of refunds from the Linked Account: [Individual Refund](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/linked-account/initiate-refund.md#individual-refunds), [Full Refund](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/linked-account/initiate-refund.md#full-refund), [Partial Refund](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/linked-account/initiate-refund.md#partial-refund) and [Batch Refund](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/linked-account/initiate-refund.md#batch-refunds).
...
- [Reversals and Settlements](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/linked-account/reversals-settlements.md)
- [Manage Profile and Team](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/route/linked-account/manage-profile.md)
