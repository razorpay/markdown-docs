...
### 3. How do I know the allowed payers list?
       ...
       You can fetch the `allowed_payers` list using [Webhook](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/smart-collect.md) or API response.
...
### 4. With which banks can I open a Current/Escrow Account?
         ...
         You can open a [Current account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/account-types/current-account.md)/[Escrow account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/account-types/escrow.md) with Yes Bank or Axis Bank. 
        

    
### 5. How do I make payouts from the Escrow/Current account?

         You can make payouts using the [Payouts APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/api.md).
