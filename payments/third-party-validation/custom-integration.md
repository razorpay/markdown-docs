...
### Prerequisites
     ...
     - [Generate API Keys from the Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#generate-api-keys) if not done already.
...
### 1.3 Fetch Payment Methods
     ...
     Know more about the various [payment methods](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods.md).
