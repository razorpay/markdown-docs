...
1. You should have already integrated one of the following:
    - [Razorpay Web Integration - Custom Checkout](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/custom.md).
    - [Razorpay Android Integration - Custom Checkout](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/android-integration/custom.md).
...
On desktop browsers, the Collect request flow works the same way as [Razorpay's UPI](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/custom/payment-methods.md#upi).
...
1. Add Razorpay.js to your website
    ...
    Know more about [Custom Web Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/custom.md).
...
Refer to the [Success/Error Callbacks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/custom/build-integration.md#14-store-fields-in-your-server) section for more details.
...
This is the same as the existing [UPI Collect Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/android-integration/custom/payment-methods.md#collect-flow).
