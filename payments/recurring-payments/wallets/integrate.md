...
>         
        ...
        **Step 1:** [**Create a Customer**](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/recurring-payments/wallets/create-authorization-transaction.md#111-create-a-customer)
        ...
        **Step 2:** [**Create an Order**](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/recurring-payments/wallets/create-authorization-transaction.md#112-create-an-order)
        ...
        **Step 3:** [**Create Authorisation Payment**](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/recurring-payments/wallets/create-authorization-transaction.md#113-create-an-authorization-payment)
        ...
        **Create a Registration Link** using:
        - [APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/recurring-payments/wallets/create-authorization-transaction.md#121-create-a-registration-link)
...
- [APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/recurring-payments/wallets/tokens.md)
...
### How to Charge Customers
        ...
        **Step 1:** [**Find the Token**](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/recurring-payments/create.md#3-search-for-the-token)
        
        Use the Dashboard search to locate the customer's token. Verify the token status is **confirmed**.

        **Step 2:** [**Create a Charge**](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/recurring-payments/create.md#4-charge-the-token)
...
>         
        ...
        **Step 1:** [**Create an Order**](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/recurring-payments/wallets/create-subsequent-payments.md#31-create-an-order-to-charge-the-customer)
        ...
        **Step 2:** [**Create a Recurring Payment**](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/recurring-payments/wallets/create-subsequent-payments.md#32-create-a-recurring-payment)
...
### Related Information
[List of Wallets APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/recurring-payments/wallets/apis.md)
