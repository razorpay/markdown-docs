...
The iOS integration for Amazon Pay is similar to the [Razorpay iOS Custom UI SDK](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/ios-integration/custom.md) integration.
