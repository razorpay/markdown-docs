...
- [Onboarding Flow](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/upi/turbo-upi.md#onboarding-flow)
- [Transactional Flow](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/upi/turbo-upi.md#transactional-flow)
- [Non-Transactional Flow](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/upi/turbo-upi.md#non-transactional-flow)
...
Perform the following steps to integrate Turbo UPI:
     ...
     - [Android Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/android-integration/standard/payment-methods/turbo-upi.md)
     - [iOS Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/ios-integration/standard/payment-methods/turbo-upi.md)
    
    
     - [Android Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi.md)
     - [iOS Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/ios-integration/custom/payment-methods/turbo-upi.md)
