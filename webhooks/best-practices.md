...
You can also manually disable webhooks from the Dashboard. Know more about [Payments Deactivation](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/setup-edit-payments.md#deactivation) and [RazorpayX Deactivation](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/setup-edit-payouts.md#deactivation).
...
Ideally, you should receive a webhook in the order in which the webhook events occur. However, you may not always receive the webhooks in order. Know more about [Order of Webhooks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/validate-test.md#order-of-webhooks).
...
You can [verify webhook signatures](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/validate-test.md#validate-webhooks) to confirm that received events are sent from Razorpay.
You can also [resolve webhook signature validation errors](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/faqs.md#3-how-to-resolve-webhook-signature-validation-errors).
