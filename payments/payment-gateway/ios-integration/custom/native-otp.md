...
2. Integrate with the [Razorpay iOS Custom SDK](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/ios-integration/custom.md).
...
> **Handy Tips**
> 
> To reuse the Razorpay Checkout web integration inside a WebView on Android or iOS, pass a [callback_url](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/callback-url.md) along with other checkout options to process the desired payment.
> 
