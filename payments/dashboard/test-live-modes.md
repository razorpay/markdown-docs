...
> 
> You have to generate a separate set of API keys for Live and Test modes. Know more about [Generating API Keys on Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/api-keys.md).
> 
