...
- Ensure you enable [Magic Checkout](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/troubleshooting-faqs.md#3-how-do-i-check-if-magic-checkout) on your account.
- Integrate [Magic Checkout With Shopify Store](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/shopify.md).
- Integrate with [Capacitor Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/capacitor-integration.md).
- Generate [Live API Keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings.md#api-keys) from the Dashboard. 
