...
You can use Subscriptions to charge a customer periodically. A Subscription contains details like the plan, the start date, the total number of billing cycles, the free trial period (if any) and the upfront amount to be collected. 
 ...
 Below are the steps to integrate Subscriptions. You can also refer to our comprehensive [Subscriptions Integration guide](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/integration-guide.md).

 1. [Create a Plan](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/subscriptions/create-plan.md)
 2. [Create a Subscription](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/subscriptions/create-subscription.md)
 3. [Checkout Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/integration-guide.md#step-14-integrate-with-standard-checkout/)

 Fork the Razorpay Postman Public Workspace and try the Subscription APIs using your [Test API Keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#generate-api-keys).
...
[Integrate With Subscriptions](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/integration-guide.md)
[Set Up Webhooks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/setup-edit-payments.md)
[Webhook Payloads](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/subscriptions.md)
