...
### 5. How to reconcile settlements along with the transactions made?
         ...
         You can [download a daily or a monthly report](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/reports.md#generate-reports) for the **Settlement Reconciliation Report** from the **Reports** section on the Dashboard. The report contains transactions and the corresponding settlement ids.
...
### 4. How to reconcile settlements along with the transactions made?
         ...
         You can [download a daily or a monthly report](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/reports.md#generate-reports) for the **Settlement Reconciliation Report** from the **Reports** section on the Razorpay  Dashboard. The report contains transactions and the corresponding settlement ids.
...
### 3. Is it mandatory to use Smart Settlements if the amount is > 5 L?
         ...
         Find out more about [Instant Vs Smart Settlements](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/settlements/instant.md#instant-vs-smart-settlements)
