...
You can automate this process to an extent by setting [**Purpose Rules**](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/accounting/zohobooks.md#rules). This means that you can select a corresponding **Tax Slab** and the **Tally Expense Account** to which you want the payouts, with that particular purpose, to sync. 
