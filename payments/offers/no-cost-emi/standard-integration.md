...
After creating [No Cost EMI Offers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/no-cost-emi/create.md) from the Dashboard, you must integrate them with the Razorpay Standard Checkout so your customers can avail of them while making payments.
...
---
**Amount Match** | Order amount should be more than or equal to the [Minimum Order Amount](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/no-cost-emi/create.md) set in an offer.
---
...
This is the easiest way to display No Cost EMI offers at the Checkout. While [creating the  No Cost EMI offer](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/no-cost-emi/create.md) from the Dashboard, enable the **Show Offer on Checkout** option.
...
You can [create  No Cost EMI offers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/create.md#create-offers) from the Dashboard.
...
### Related Information
- [About No Cost EMI Offers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/no-cost-emi.md)
...
- [Tutorial - How to Create No Cost EMI Offers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/no-cost-emi/tutorial.md)
- [No Cost EMI FAQs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/low-cost-emi/faqs.md)
- [Disable Offers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/offers/no-cost-emi/create.md#disabling-no-cost-emi-offers)
