...
### Prerequisites
         ...
         2. Integrate with [Razorpay iOS Custom SDK](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/ios-integration/custom/build-integration.md).
