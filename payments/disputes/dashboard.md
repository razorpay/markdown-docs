...
- [Subscribe to Webhook Events](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/disputes/subscribe-to-webhooks.md)
...
- View all the disputes raised by your customer using [Fetch All Disputes API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/disputes/fetch-all.md)
- View the details of a dispute by providing the dispute id using [Fetch a Dispute API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/disputes/fetch.md)
...
Accept a dispute using the [Accept a Dispute API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/disputes/accept.md).
...
- Contest a dispute using [Contest a Dispute API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/disputes/contest.md)
- Upload supporting documents using [Documents API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/documents.md)
...
- [About Disputes](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/disputes.md)
