...
Know how you can [set Payout Links to expire](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payout-links/set-expiry.md) after a certain duration. 

### Rejected

A Payout Link moves to the `rejected` state if it is rejected by the Approver. This status is applicable only for cases where [Approval Workflow](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/manage-teams/approval-workflow.md) is enabled.
...
Refer to [Payout Life Cycle and States](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts.md#payout-life-cycle) for more information.

### Related Information

- [About Payout Links](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payout-links.md)
- [Bulk Payout Links](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payout-links/bulk.md)
