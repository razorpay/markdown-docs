...
With the accounting assistant, the [RazorpayX-Tally Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/tally.md), you can: 
...
2. The bills received from the below-mentioned modes are auto-read by the RazorpayX AI OCR reader. You can create bills in RazorpayX via: - [Vendor Portal](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/portal/business.md)
- [Bulk drag and drop](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/bulk-invoices.md)
- [Email Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/invoices.md#add-invoices-through-email)
 You can pay bills in RazorpayX via: - [Bulk Payouts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/vendor-payouts/bulk.md)
- [Partial Payouts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/vendor-payouts/partial-payouts.md)
- [Scheduled Payouts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/vendor-payouts/scheduled-payouts.md)
...
When you [generate an invoice](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments.md) in Vendor Payments, you can automate bringing that bill to Tally. 
...
After you [create an invoice](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments.md) in Vendor Payments, sync the bill in Tally. To do so: 
