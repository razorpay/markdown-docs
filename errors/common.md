...
> **Handy Tips**
> 
> If you are using [our SDKs for integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/server-integration.md), the error responses result in exceptions that need to be handled in your integration.
> 
...
1. Go to the [Create an Order API endpoint page](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/orders/create.md).
