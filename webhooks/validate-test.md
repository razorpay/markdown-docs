...
1. `payout.pending` (if you have [Approval Workflow](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/manage-teams/approval-workflow.md) enabled on your account)
2. `payout.queued` (in case your [business account does not have sufficient balance to process the payout](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/queued.md))
3. `payout.initiated`
