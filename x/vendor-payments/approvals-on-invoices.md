...
First, [add invoice](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/invoices.md) on the RazorpayX Dashboard.
...
Know more about the [Invoice Life Cycle](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/life-cycle.md).
...
> **Handy Tips**
> 
> In case an [accounting integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/accounting.md) is enabled, the invoices sync only post-approval.
> 

Know how to [approve or reject invoices via email](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/approve-invoices.md).
...
- [Approve Invoices](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/approve-invoices.md)
