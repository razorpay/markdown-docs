...
1. Create a Payment Link and send them to your customers using 
    [Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-links/create.md) or [Bulk Upload feature](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-links/batch.md).
...
- [Bank Transfer FAQs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-links/faqs.md#bank-transfer)

- [Bank Transfer as a Payment Method](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/bank-transfer.md)

- [About Customer Identifiers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/smart-collect.md)
