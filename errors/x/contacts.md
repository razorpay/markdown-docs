...
When firing [Contact APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/contacts.md), you might run into errors for various reasons. These error codes are returned in an error body, which you can use to understand the reason for the error and the steps to resolve it.
...
`field`
: The Contact details in the [Contact entity](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/contacts.md#contact-entity) such as `name`, `email`, `type` and so on.

### Related Information

- [Contact APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/contacts.md)
