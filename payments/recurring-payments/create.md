...
> 
> You can create registration links using APIs. Refer to the [API section](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/recurring-payments.md) for more details.
> 
