...
You can use Razorpay [Webhooks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks.md) to receive notifications of all events related to Subscriptions.
...
Know more about [Webhooks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks.md) and check the [sample payloads](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/subscriptions.md).
