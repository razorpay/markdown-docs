...
1. [Build Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/partners/aggregators/onboarding-ui/build-integration.md): Perform the steps on your website/app and the Razorpay Dashboard.
2. [Test Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/partners/aggregators/onboarding-ui/test-integration.md): Test the integration before going live with the integration.

### Related Information

- [Fetch Merchant Account Onboarding Status](https://raw.githubusercontent.com/razorpay/markdown-docs/master/partners/aggregators/onboarding-ui/status.md)
