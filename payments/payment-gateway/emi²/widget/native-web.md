...
`key` _mandatory_
: `string` API Key ID generated from the [Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#generate-api-keys). For example, `rzp_test_XXXX00000XXXX`.
...
After you preview the widget, switch to live mode and replace the test API keys in the sample code with the live ones to take the integration live. Know more about [live API keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#live-mode-api-keys).
...
> - [EMI](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/faqs.md#1-what-are-the-standard-credit-card-interest) 
> - [Cardless EMI](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/faqs.md#cardless-emi)  
> - [Pay Later](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/faqs.md#2-what-are-the-standard-interest-rates-charged)
> 
...
After you successfully integrate the widget on your website, you can choose to [customise the widget](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/native-web/customise.md) based on your requirement.
...
- [Affordability Widget FAQs for Native website](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/faqs.md#native-website)
...
- [Integrate Affordability Widget on your Android app](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/android.md)
