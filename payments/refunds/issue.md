...
5. Look for the **Refund Instantly** check box.
    ...
    - If you want to issue an [instant refund](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/refunds/instant.md), select the **Refund Instantly** check box.
...
To create a normal refund, use [Create a Normal Refund API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/refunds/create-normal.md).
...
- [Batch Refunds](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/refunds/batch.md)
