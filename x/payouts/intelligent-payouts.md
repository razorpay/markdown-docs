...
> **Watch Out!**
> 
> Intelligent payouts is available by default for Current Account users. RazorpayX Lite users must consume `payout.failed` [webhook](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks.md#payout-failed) to enable Intelligent payouts.
> 
...
You can customise the SLA by contacting our [Support Team](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/support.md#razorpayx-users).
...
- [Webhooks](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks/setup-edit-payouts.md)
