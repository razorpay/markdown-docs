...
: `string` Unique identifier of the customer. You can create a customer using [API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/customers.md) or via the [Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/customers.md#create-a-customer).
...
All server-side requests must be [authenticated](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api.md#authentication) with `Basic Auth` using the [KEY_ID] as username. You can generate your API keys on the [Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/authentication.md#generate-api-keys).
