...
### 1.2 Initialize Razorpay Android Standard SDK
     ...
     Add your `` dynamically using Checkout's `setKeyId()` method. You can generate the [API Keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/api-keys.md#generate-api-keys) from the Dashboard.
...
### Related Information
[Google Play's Data Safety](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/android-integration/standard/google-data-safety.md)
