...
Refer to the [API Reference](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api.md) guide to understand the basic concepts of API.
...
> **Handy Tips**
> 
> Before creating a wallet, you must create a [customer](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/customers.md#create-a-customer).
> 
...
> 
> If the customer's wallet has an insufficient balance for the requested payment, the API returns an error. The customer must [load sufficient amount in the wallet](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/wallet/wallet-operations.md#load-a-wallet) to complete the transaction.
> 
...
`utr`
: `string` A unique transaction reference (UTR) number generated for all transactions. You can obtain UTR from the [`payout.updated` webhook payload](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks.md).
