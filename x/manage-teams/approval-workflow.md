...
1. Confirm saving workflow and [2FA](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/manage-teams/2fa.md) to create workflow successfully.
...
In addition to the [webhook events available for payouts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/webhooks.md), the Approval Workflow has the following events.
...
- [Manage Teams](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/manage-teams.md)
- [Chartered Accountant Portal](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/manage-teams/ca-portal.md)
- [Invoices - Approval Workflow](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/approvals-on-invoices.md)
