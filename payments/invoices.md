...
You can create roles/teams for different levels of actions on invoices (create, view, edit and so on). Know more about [roles and actions](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/dashboard/account-settings/manage-team.md).
...
You can create non-GST invoices in any of the [supported international currencies](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments.md#supported-currencies) using the Dashboard or APIs.
...
### What Next
Understand [how you can use Razorpay Invoices](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/invoices/how-it-works.md) and the various [Invoice states](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/invoices/states.md).
