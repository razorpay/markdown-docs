...
### 8. I am not able to verify my URL via the self-serve dashboard. What should I do?
    ...
    Follow the [Apple Pay documentation](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/apple-pay.md) and ensure the file is publicly accessible.
...
- [Apple Pay S2S Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/apple-pay/s2s-integration.md)
- [Apple Pay Custom Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-methods/apple-pay/custom-integration.md)
