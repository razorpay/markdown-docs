...
### 3. How does the integration work?
         ...
         - [Native website](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/native-web.md). 
         - [WooCommerce website](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/woocommerce.md).
         - [Shopify store](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/shopify.md).
...
### 5. Is the widget available on Android and iOS SDKs?
         ...
         The widget is available on [Android](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/android.md) but **not** on iOS SDK.
...
### 8. What are the various features of the Affordability Widget that will help increase customer conversion?
         ...
         - [Discount Whisperer](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/features.md#discount-whisperer).
         - [Eligibility Check](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/features.md#eligibility-check).
         - [Checkout from Widget](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/features.md#checkout-from-widget).
...
### 1. What customisations are possible in the widget?
         ...
         Know more about the [customisation options](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/native-web/customise.md).
...
### 2. Can I disable offers?
         ...
         Know more about how to [disable offers](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/native-web/customise.md#14-disable-the-offers).
...
### 3. How can I alter the appearance of the widget?
         ...
         Know more about [themes and colours](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/native-web/customise.md#3-themes-and-colours).
...
### 5. What does the customer journey look like after integrating Checkout from Affordability Widget?
         ...
         3. They are then redirected to the Razorpay checkout if you have integrated the widget with our [Standard Checkout](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/standard-integration.md). If not, they are redirected to your custom-built checkout. 
...
### 6. What are the prerequisites to enable the Checkout from Affordability Widget feature?
          ...
          - Integrate with the [Razorpay Affordability Widget](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/native-web.md). This feature is only supported on Native Website.
          - Integrate with [Razorpay Standard Checkout](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/standard.md).
          - Integrate Checkout from Widget using [Standard Integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/standard-integration.md).
...
### 1. I am integrating with Razorpay Plugin for the first time. What are the steps that I need to follow?
         ...
         You can now follow the [integration steps](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/woocommerce.md#integration-steps).
...
### 2. How does the integration work?
         ...
         2. Create a [Razorpay account](https://dashboard.razorpay.com/signup) and follow the [integration steps](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/woocommerce.md#integration-steps).
...
### 4. What customisations are possible in the widget?
         ...
         Know more about the [customisation options](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/woocommerce/customise.md). 
...
### 1. How can I enable the widget on my Shopify store?
         ...
         1. Create a [Razorpay account](https://dashboard.razorpay.com/signup) and perform the [EMI² integration](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/shopify.md#integration-steps) steps on your Shopify store.
...
### 6. What customisations are possible in the widget?
         ...
         Know more about the [customisation options](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/shopify/customise.md).
...
### 8. What themes are compatible with the Razorpay Affordability Widget on the Shopify store?
         ...
         To see the list of themes that are compatible with the Razorpay Affordability Widget on the Shopify store, refer to [Compatible Themes](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget/shopify.md#compatible-themes).
...
- [EMI² Suite FAQs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/faqs.md)
- [About Affordability Widget](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/emi²/widget.md)
