...
Descriptions for the checkout options parameters are present in the [Checkout Options](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/standard/integration-steps.md#123-checkout-options) table.
...
Descriptions for the request parameters are present in the [Create an Order Request Parameters](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/orders/create.md) table.
