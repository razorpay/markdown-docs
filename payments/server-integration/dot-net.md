...
You must use .NET v4.5 or higher with TLS version 1.2. Using it with a lower .NET version will lead to [errors](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/server-integration/dot-net/troubleshooting-faqs.md). Know more about the [latest .NET versions](https://versionsof.net/framework/).
