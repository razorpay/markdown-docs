...
6. You can either **Invite all vendors** or **Select vendors** from the contact list. Only the [Contact type](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/contacts.md#contact-types) saved as **vendor** is eligible to use the portal.
...
> **Handy Tips**
>  
> Check and share the url: [https://razorpay.com/docs/x/vendor-payments/portal](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/portal.md) with your vendors for them to see the activities they can perform on the portal.
> 
...
- [Bulk Payouts](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/vendor-payments/vendor-payouts/bulk.md)
