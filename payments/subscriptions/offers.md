...
1. [Create an Offer from the Dashboard](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/offers/create.md).
1. [Create a Plan for the Subscription](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/create-plans.md#create-a-plan).
1. [Link the Offer to a Subscription](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/offers/link.md).
...
- [Link an Offer to a Subscription](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/subscriptions/offers/link.md)
