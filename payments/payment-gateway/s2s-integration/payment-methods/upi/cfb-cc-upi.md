...
- Integrate with Server-to-Server (S2S) integration:
  - [S2S JSON V2 (Latest)](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/s2s-integration/json/v2.md)
  - [S2S JSON V1](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/s2s-integration/json/v1.md)
  - [S2S Redirect](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/s2s-integration/redirect.md)
...
: `string` Unique identifier of the order created using the [Orders API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/orders/create.md).
...
Refer to the [Settlement APIs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/settlements/apis.md).
