...
When customers authenticate through [Login with Razorpay (SSO)](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/login-with-razorpay.md), their activity is captured in the **Customer Analytics** dashboard. It displays login metrics, account creation data, and customer-level insights to help you track engagement, understand user behaviour, and retarget high-intent customers across marketing channels.
...
[Automatic Customer Tagging for Retargeting](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/magic-checkout/login-with-razorpay/automation-tags.md)
