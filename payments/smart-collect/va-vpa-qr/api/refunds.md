...
`notes` _optional_
: `json object` Array of notes fields. You can enter custom data in key-value pairs. Refer the [Notes section of the API Reference](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/understand.md#notes) documentation to learn more.
...
`currency`
: `string` The currency in which the payment is made. We support [international currencies](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/international-payments.md#supported-currencies).
...
Refer [Refunds API](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/refunds.md) to perform other refund-related operations:
