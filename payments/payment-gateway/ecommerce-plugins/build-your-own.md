...
### 3. Display the Checkout Form on Your Website to Your Customer.
     ...
     You can display the [Standard Checkout form](https://raw.githubusercontent.com/razorpay/markdown-docs/master/payments/payment-gateway/web-integration/standard.md) on your website to collect payments from customers. Ensure that the `order_id` option is passed along with the other checkout options mentioned below.
