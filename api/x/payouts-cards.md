...
[Allowlist IPs](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/dashboard/allowlist-ip.md) that you use while making payouts via APIs and pass the [idempotency key](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/payout-idempotency.md). [Create a Contact](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/contacts/create.md) and [Fund Account](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/x/fund-accounts.md) before creating payouts.

Fork the Razorpay Postman Public Workspace and try the Payouts to Cards APIs using your [Test API Keys](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/dashboard/api-keys.md).
...
[About Payout to Cards](https://raw.githubusercontent.com/razorpay/markdown-docs/master/x/payouts/cards.md)
...
[Status Details](https://raw.githubusercontent.com/razorpay/markdown-docs/master/errors/x/payout-status-details.md)
