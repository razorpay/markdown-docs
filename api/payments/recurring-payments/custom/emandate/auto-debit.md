...
> **Note**
> 
> You can also retrieve the `token_id` via the [payment.authorized webhook](https://raw.githubusercontent.com/razorpay/markdown-docs/master/api/payments/recurring-payments/webhooks.md#payment-authorized).
> 
